        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
          <div class="position-sticky pt-3 sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold fs-5 <?php if(basename($_SERVER['PHP_SELF']) == 'propic.php') echo 'rounded-4 border border-4 bg-primary text-white' ?>" href="propic.php">
                  <span class="align-text-bottom"></span>
                  <i class="bi bi-person-square"></i> Picture
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold fs-5 <?php if(basename($_SERVER['PHP_SELF']) == 'bg.php') echo 'rounded-4 border border-4 bg-primary text-white' ?>" href="bg.php">
                  <span class="align-text-bottom"></span>
                  <i class="bi bi-images"></i> Background
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold fs-5 <?php if(basename($_SERVER['PHP_SELF']) == 'desc.php') echo 'rounded-4 border border-4 bg-primary text-white' ?>" href="desc.php">
                  <span class="align-text-bottom"></span>
              ...
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold fs-5 <?php if(basename($_SERVER['PHP_SELF']) == 'sns.php') echo 'rounded-4 border border-4 bg-primary text-white' ?>" href="sns.php">
                  <span class="align-text-bottom"></span>
                  <i class="bi bi-globe-asia-australia"></i> SNS
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold fs-5 <?php if(basename($_SERVER['PHP_SELF']) == 'setpass.php') echo 'rounded-4 border border-4 bg-primary text-white' ?>" href="setpass.php">
                  <span class="align-text-bottom"></span>
