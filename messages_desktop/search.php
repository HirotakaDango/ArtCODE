  ...
  <body>
    <div class="container px-0 mb-5">
      <div class="btn-group w-100 mb-2 gap-2">
        <a class="btn bg-body-tertiary p-2 rounded-4 w-50 fw-bold text-nowrap fs-5" href="desktop.php">Current Contacts</a>
        <a class="btn bg-body-tertiary p-2 rounded-4 w-50 fw-bold opacity-75 text-nowrap fs-5" href="search.php">Search Users</a>
      </div>
      <form class="">
