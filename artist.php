  ...
  <body>
    ...
    <div class="roow mb-2">
      <div class="cool-6 text-center">
        <div class="caard art">
          <div class="col-md-5 order-md-1 mt-3 b-radius position-relative" style="background-image: url('<?php echo $bgpic; ?>'); background-size: cover; height: 200px; width: 100%;">
            <img class="img-thumbnail rounded-circle position-absolute top-50 start-50 translate-middle" src="<?php echo !empty($pic) ? $pic : "icon/profile.svg"; ?>" alt="Profile Picture" style="width: 110px; height: 110px; object-fit: cover;">
            <button class="btn btn-sm btn-dark opacity-75 rounded-3 position-absolute top-0 end-0 m-1" data-bs-toggle="modal" data-bs-target="#modalUserInfo"><i class="bi bi-info-circle-fill"></i></button>
          </div> 
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control fw-bold text-end" value="<?php echo !empty($id) ? $id : ''; ?>" readonly>
              </div>
              <div class="input-group mb-2">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control fw-bold text-end" value="<?php echo !empty($born) ? date('Y/m/d', strtotime($born)) : ''; ?>" readonly>
              </div>
            </div>
          </div>
        </div>
