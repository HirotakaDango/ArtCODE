          ...
          <div class="caard border-md-lg">
            ...
            <div class="me-2 ms-2 rounded fw-bold">
              <div class="d-flex d-md-none d-lg-none gap-2">
                <?php if (basename($_SERVER['PHP_SELF']) !== 'demo_simplest_view.php'): ?>
                  <?php if ($next_image): ?>
              ...
              <?php endif; ?>
              <?php if (!in_array(basename($_SERVER['PHP_SELF']), ['demo_simple_view.php', 'demo_simplest_view.php', 'demo_view.php']) && basename($_SERVER['PHP_SELF']) === 'demo_full_view.php'): ?>
              ...
              <?php
                if (basename($_SERVER['PHP_SELF']) !== 'demo_simplest_view.php' && basename($_SERVER['PHP_SELF']) !== 'demo_simple_view.php') {
                  include('demo_imguser.php');
                }
              ?>
