...
$stmt = $db->prepare("SELECT forum.*, users.artist, users.pic, users.id as iduser FROM forum JOIN users ON forum.email = users.email ORDER BY forum.id ASC LIMIT :items_per_page OFFSET :offset");
