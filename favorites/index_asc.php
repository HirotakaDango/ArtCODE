...
$query = $db->prepare('SELECT images.* FROM images JOIN favorites ON images.id = favorites.image_id WHERE favorites.email = :email ORDER BY favorites.id ASC LIMIT :limit OFFSET :offset');
