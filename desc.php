    ...
    <div class="container-fluid">
      ...
      <form method="POST">
        <div class="form-floating mb-3">
          <textarea class="form-control rounded-3 border text-secondary fw-bold border-4" id="desc" name="desc" rows="5" style="height: 400px;" oninput="stripHtmlTags(this)" placeholder="Description:" maxlength="400"><?php echo strip_tags($current_desc); ?></textarea>
