...
$countStmt = $db->prepare("SELECT COUNT(*) FROM images
                            INNER JOIN following ON images.username = following.following_username
                            WHERE following.follower_username = :username");
$countStmt->bindValue(':username', $username, SQLITE3_TEXT);
