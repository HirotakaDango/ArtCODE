...
<html lang="en">
  ...
  <body>
    ...
    <h3 class="text-secondary fw-bold mt-2 mb-2 ms-2"><i class="bi bi-clock-history"></i> Recents</h3>
    <div class="content">
    ...
    <div class="mt-2 mb-2 d-flex justify-content-center">
      <?php
        ...
        if ($page > 1) {
          echo '<a class="fs-1 fw-bold text-secondary" href="?page=' . $prevPage . '"><i class="bi bi-arrow-left-square-fill"></i></a>';
        }

        echo '<h3 class="ms-2 me-2 text-secondary text-center fw-bold mt-1">page ' . $page . '</h3>';

        if ($page < $totalPages) {
          echo '<a class="fs-1 fw-bold text-secondary" href="?page=' . $nextPage . '"><i class="bi bi-arrow-right-square-fill"></i></a>';
        }
      ?>
    </div>
    <style>
