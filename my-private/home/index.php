...
if (isset($_POST['favorite'])) {
  ...
  $existing_fav = $db->querySingle("SELECT COUNT(*) FROM private_favorites WHERE email = '$email' AND image_id = $image_id");

  if ($existing_fav == 0) {
    $db->exec("INSERT INTO private_favorites (email, image_id) VALUES ('$email', $image_id)");
  }
  ...
  $image_id = $_POST['image_id'];
  $db->exec("DELETE FROM private_favorites WHERE email = '$email' AND image_id = $image_id");
