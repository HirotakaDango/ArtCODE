  ...
  if (isset($_GET['title']) && isset($_GET['id'])) {
    ...
    $query = "
      ...
      WHERE private_images.id = :image_id
        AND private_images.episode_name = :episode_name
        AND private_images.artwork_type = 'manga'
    ";
    ...
    $query_child = "SELECT * FROM private_image_child WHERE image_id = :image_id ORDER BY id ASC";
    ...
    $viewerBaseUrl = "/my-private/manga/view.php";
              ...
              <a href="<?= $link_page_1 ?>" onclick="event.preventDefault(); window.top.location.href=this.href;">
                <div class="ratio-cover">
                  <img class="rounded lazy-load"
                       data-src="<?= '/private_thumbnails/' . $image_details['filename']; ?>"
