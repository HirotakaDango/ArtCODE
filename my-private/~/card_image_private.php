                            ...
                            <div id="div1_<?php echo $image['id']; ?>" class="overflow-auto col-md-7 h-100 scrollable-div">
                              <div>
                                <a href="/image.php?artworkid=<?php echo $image['id']; ?>">
                                  <img class="object-fit-cover shadow lazy-load h-100 w-100" data-src="/private_thumbnails/<?php echo $image['filename']; ?>" alt="<?php echo $image['title']; ?>">
                                </a>
                              </div>
                            </div>
                                ...
                                <div class="collapse mt-2" id="collapseInfoDesktop_<?php echo $image['id']; ?>">
                                  <div class="card rounded-4 container">
                                    ...
                                    <?php
                                      ...
                                      $base_url = 'http://' . $_SERVER['HTTP_HOST'] . '/private_images/';
                                    
                                      // Define the local file system path to the image folder
                                      $image_folder_path = $_SERVER['DOCUMENT_ROOT'] . '/private_images/';
                                      ...
                                      $child_images_result = $db->query("SELECT filename FROM private_image_child WHERE image_id = " . $image['id']);
