              ...
              <?php if (basename($_SERVER['PHP_SELF']) !== 'private_simplest_view.php'): ?>
                <?php if (isset($image['episode_name']) && !empty($image['episode_name'])): ?>
                  ...
                  <div class="btn-group gap-2 w-100 mb-2">
                    <a class="btn btn-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/opposite.php'); ?> fw-bold rounded-4 w-50" target="_blank" href="/my-private/manga/title.php?title=<?php echo urlencode($image['episode_name']); ?>&uid=<?php echo $user['id']; ?>">
                      <small>go to manga</small>
                    </a>
                    <a class="btn btn-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/opposite.php'); ?> fw-bold rounded-4 w-50" target="_blank" href="/my-private/view/manga/?artworkid=<?php echo $image['id']; ?>&page=1">
