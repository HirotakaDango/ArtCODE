<?php
// Get the private_images for the current page and specified episode with non-empty episode names, filtered by user ID and favorited by the current user
$stmt = $db->prepare("
    ...
    WHERE private_images.episode_name = :episodeName 
      AND private_images.episode_name != ''
      AND users.id = :userId
      AND private_favorites.email = :email
