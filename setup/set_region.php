...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  header("Location: set_region.php");
  exit;
}
  ...
  <body>
    <div class="container mb-5 mt-4">
      ...
      <div class="card border-0 bg-body-tertiary rounded-4 shadow-sm p-4 mb-4">
        ...
        <p class="text-muted mb-4">Set your region settings to personalize your experience on the website.</p>
      ...
      <div class="d-flex">
        <div class="ms-auto btn-group gap-2 mt-2">
          ...
          <a href="set_date.php" class="btn border-0 text-dark rounded fw-medium">Next</a>
        </div>
      </div>
    </div>  
