          ...
          <div class="card">
            ...
            <div class="card-body">
              <canvas id="user-chart"></canvas>
                ...
                echo "<a class='btn btn-sm btn-primary fw-bold me-1' href='../admin/index.php?page=users'>manage user</a>";
                echo "<a class='btn btn-sm btn-danger fw-bold ms-1' href='../admin/index.php?page=danger_zone'>danger zone</a>";
              ?>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <?php
                ...
                echo "<a class='btn btn-sm btn-primary fw-bold me-1' href='../admin/index.php?page=images'>manage images</a>";
