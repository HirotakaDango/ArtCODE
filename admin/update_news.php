  ...
  public function addData() {
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add'])) {
      $data = [
        ...
        'description' => nl2br(filter_input(INPUT_POST, 'description', FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_STRIP_LOW)),
...
?>
    ...
    <center><button type="button" class="btn btn-primary fw-bold mt-2 mb-2" data-bs-toggle="modal" data-bs-target="#add">Add News</button></center>
    <center>
          ...
          <?php if ($edit_data !== null): ?>
            <div class="card text-secondary fw-bold container">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <textarea style="height: 200px;" type="text" placeholder="description" oninput="stripHtmlTags(this)" name="description" value="<?php strip_tags($edit_data['description']); ?>" class="form-control" required><?= strip_tags($edit_data['description']) ?></textarea>
                </div>

                <div class="mb-3">
                  <input type="text" placeholder="preview" name="preview" value="<?= $edit_data['preview'] ?>" class="form-control">
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <input type="text" name="preview" class="form-control" placeholder="enter link for image preview">
                </div> 
                <div class="mb-3">
