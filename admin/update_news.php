          ...
          <?php if ($edit_data !== null): ?>
            <div class="card text-secondary fw-bold container">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <textarea row="5" type="text" placeholder="description" name="description" value="<?= $edit_data['description'] ?>" class="form-control" required><?= $edit_data['description'] ?></textarea>
                </div>
