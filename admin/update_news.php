          ...
          <?php if ($edit_data !== null): ?>
            <div class="card text-secondary fw-bold container">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <input type="text" placeholder="description" name="description" value="<?= $edit_data['description'] ?>" class="form-control" required>
                </div>
          ...
          <?php foreach ($data as $row): ?>  
            <div class="card mb-3">
              ...
              <div class="card-body text-secondary fw-bold">
                <p class="text-start ms-3">User ID: <?= $row['title'] ?></p>
                <p class="text-start ms-3">Email: <?= $row['description'] ?></p>
                <p class="text-start ms-3">Email: <?= $row['created_at'] ?></p>
              </div>
            </div>
          <?php endforeach; ?> 
        </div>
