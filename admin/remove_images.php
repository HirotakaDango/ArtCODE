    ...
    <div class="container mt-5">
      <div class="card">
        <?php
          ...
          echo '<div class="card-header bg-primary text-white fw-bold">
                  <i class="bi bi-images"></i>
                  Images
                </div>
                <div class="card-body">
                  <img src="../thumbnails/' . $row['filename'] . '" class="rounded">
                  <h5 class="card-title mt-1">' . $row['filename'] . '</h5>';

                  // Display the image thumbnail
                  echo '<p class="card-text fw-bold mt-1">Username: ' . $row['username'] . '</p>';
                  echo '<p class="card-text fw-bold mt-1">Tags: ' . $row['tags'] . '</p>';
