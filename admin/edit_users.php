...
?>
    ...
    <center class="mt-2"><button type="button" class="btn btn-primary fw-bold" data-bs-toggle="modal" data-bs-target="#add">Add User</button></center>
    <center>
          ...
          <?php if ($edit_data !== null): ?>
            <div class="card text-secondary fw-bold container">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <textarea style="height: 200px;" type="text" placeholder="bio" name="desc" value="<?= $edit_data['desc'] ?>" class="form-control" required><?= $edit_data['desc'] ?></textarea>
                </div> 
          ...
          <?php foreach ($data as $row): ?>  
            <div class="card mb-3">
              <div class="card-header bg-primary text-white fw-bold">
                ...
                Users <a href="?page=users&edit=<?= $row['id'] ?>" class="btn-sm text-white float-end"><i class="bi bi-pencil-fill"></i></a>
              </div>
