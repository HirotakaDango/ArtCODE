...
if (isset($_GET['username']) && isset($_GET['password']) && $username === 'Admin' && $password === 'Admin') {
              ...
              <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-body p-5 pt-0">
                  ...
                  <form class="">
                    ...
                    <button class="fw-bold w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit">Enter</button>
                  </form>
                </div>
              </div>
            </div>
