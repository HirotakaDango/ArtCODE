          ...
          <div class="col">
            <div class="position-relative">
              <a class="rounded ratio ratio-1x1" href="/image.php?artworkid=<?php echo $image['id']; ?>">
                <img class="rounded rounded-bottom-0 shadow object-fit-cover lazy-load" data-src="/thumbnails/<?php echo $image['filename']; ?>" alt="<?php echo $image['title']; ?>">
              </a> 
              <?php
              ...
              <?php include($_SERVER['DOCUMENT_ROOT'] . '/rows_columns/image_counts.php'); ?>
                <div class="dropdown">
                  ...
                  <?php include('card_image_favorites.php'); ?>
