              ...
              <div class="position-absolute top-0 start-0">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item fw-bold" href="/admin/images_section/edit/?id=<?php echo $imageD['id']; ?>&back=<?php echo urlencode('http' . (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 's' : '') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>"><i class="bi bi-pencil-fill"></i> <small>edit</small></a></li>
                    <?php
                  ...
                  <?php include('share_artist_daily.php'); ?>

                  <?php include($_SERVER['DOCUMENT_ROOT'] . '/admin/images_section/artist/components/card_image_daily.php'); ?>
