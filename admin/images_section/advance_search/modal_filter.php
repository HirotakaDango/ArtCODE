      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content rounded-4 border-0">
          ...
          <form method="get" class="modal-body border-0">
            ...
            <div class="form-floating mb-2">
              <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="uid" id="uid" placeholder="User ID" maxlength="15" min="1" value="<?php echo htmlspecialchars(isset($_GET['uid']) ? $_GET['uid'] : '', ENT_QUOTES); ?>">  
              <label for="uid" class="fw-medium">User ID</label>
            </div>
            <div class="row g-2 mb-2">
              <div class="col-md-4">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="year" id="year" placeholder="Year (e.g. 2023)" min="1900" max="2100" value="<?php echo htmlspecialchars($_GET['year'] ?? '', ENT_QUOTES); ?>">
                  <label for="year" class="fw-medium">Year (e.g. 2023)</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="month" id="month" placeholder="Month (1-12)" min="1" max="12" value="<?php echo htmlspecialchars($_GET['month'] ?? '', ENT_QUOTES); ?>">
                  <label for="month" class="fw-medium">Month (1-12)</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="day" id="day" placeholder="Day (1-31)" min="1" max="31" value="<?php echo htmlspecialchars($_GET['day'] ?? '', ENT_QUOTES); ?>">
            ...
            <div class="row g-2 mb-2">
              <div class="col-md-6">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="year_start" id="year_start" placeholder="Year Start" min="1900" max="2100" value="<?php echo htmlspecialchars($_GET['year_start'] ?? '', ENT_QUOTES); ?>">
                  <label for="year_start" class="fw-medium">Year Start</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="year_end" id="year_end" placeholder="Year End" min="1900" max="2100" value="<?php echo htmlspecialchars($_GET['year_end'] ?? '', ENT_QUOTES); ?>">
            ...
            <div class="row g-2 mb-2">
              <div class="col-md-6">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="month_start" id="month_start" placeholder="Month Start" min="1" max="12" value="<?php echo htmlspecialchars($_GET['month_start'] ?? '', ENT_QUOTES); ?>">
                  <label for="month_start" class="fw-medium">Month Start</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="month_end" id="month_end" placeholder="Month End" min="1" max="12" value="<?php echo htmlspecialchars($_GET['month_end'] ?? '', ENT_QUOTES); ?>">
            ...
            <div class="row g-2 mb-2">
              <div class="col-md-6">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="day_start" id="day_start" placeholder="Day Start" min="1" max="31" value="<?php echo htmlspecialchars($_GET['day_start'] ?? '', ENT_QUOTES); ?>">
                  <label for="day_start" class="fw-medium">Day Start</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-floating">
                  <input class="form-control rounded-3 fw-medium border-0 bg-body-tertiary shadow focus-ring focus-ring-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>" type="number" name="day_end" id="day_end" placeholder="Day End" min="1" max="31" value="<?php echo htmlspecialchars($_GET['day_end'] ?? '', ENT_QUOTES); ?>">
