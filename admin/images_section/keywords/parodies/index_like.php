...
// Retrieve the count of images for each parody favorited by the user
$query = "
    SELECT parodies, COUNT(*) as count
    FROM images
...
asort($currentparodies); // Sort parodies within the category
