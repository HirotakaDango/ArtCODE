      <div id="category-<?php echo $category; ?>" class="category-section pt-5">
        ...
        <div class="row">
          <?php foreach ($currentTags as $tag => $count): ?>
            <?php
            ...
            <div class="col-md-2 col-sm-5 px-0">
              <a href="/admin/images_section/keyword/?tag=<?php echo str_replace('%27', "'", urlencode($tag)); ?>" class="m-1 d-block text-decoration-none">
