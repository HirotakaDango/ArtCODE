...
// Retrieve the count of images for each character matching the search condition, sorted by count in descending order
$query = "SELECT characters, COUNT(*) as count FROM images";
if (!empty($searchCondition)) {
  $query .= " WHERE $searchCondition";
}
$query .= " GROUP BY characters ORDER BY COUNT(*) DESC";
...
arsort($currentcharacters); // Sort characters within the category by count in descending order
