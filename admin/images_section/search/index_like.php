...
$limit = $numpage > 0 ? $numpage : PHP_INT_MAX;
...
$searchTerm = isset($_GET['q']) ? trim(strtolower($_GET['q'])) : '';
...
$query .= !empty($conditions) ? implode(' OR ', $conditions) : '1=1';
$query .= ")";

// Check if q (search term) is empty
$query .= " ORDER BY id DESC"; // Order by id DESC
