                                    ...
                                    <div class="d-flex flex-wrap gap-2 mb-3">
                                      ...
                                      if (!empty($image['tags'])) {
                                        ...
                                        foreach ($tags as $tag) {
                                          ...
                                          if (!empty($tag)) {
                                            ?>
                                            <a href="/admin/images_section/keyword/?tag=<?php echo urlencode($tag); ?>" class="badge bg-dark text-decoration-none rounded-4 py-2">
                                    ...
                                    <?php if (!empty($image['characters'])): ?>
                                      ...
                                      <div class="d-flex flex-wrap gap-2 mb-3">
                                        ...
                                        foreach ($characters as $character) {
                                          ...
                                          if (!empty($character)) {
                                            ?>
                                            <a href="/admin/images_section/keyword/?character=<?php echo urlencode($character); ?>" class="badge bg-dark text-decoration-none rounded-4 py-2">
                                    ...
                                    <?php if (!empty($image['parodies'])): ?>
                                      ...
                                      <div class="d-flex flex-wrap gap-2 mb-3">
                                        ...
                                        foreach ($parodies as $parody) {
                                          ...
                                          if (!empty($parody)) {
                                            ?>
                                            <a href="/admin/images_section/keyword/?parody=<?php echo urlencode($parody); ?>" class="badge bg-dark text-decoration-none rounded-4 py-2">
                                    ...
                                    <?php if (!empty($image['group'])): ?>
                                      ...
                                      <div class="d-flex flex-wrap gap-2">
                                        ...
                                        foreach ($groups as $group) {
                                          ...
                                          if (!empty($group)) {
                                            ?>
                                            <a href="/admin/images_section/keyword/?group=<?php echo urlencode($group); ?>" class="badge bg-dark text-decoration-none rounded-4 py-2">
