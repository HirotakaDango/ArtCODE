...
if ($id) {
  // Fetch the email content without checking if it belongs to the logged-in user
  ...
  if ($emailData) {
    ...
    // Redirect if the email does not exist
    header('Location: /admin/users_section/emails/');
    exit;
  }
} else {
...
<html lang="en" data-bs-theme="dark">
  <head>
    <meta charset="UTF-8">
    <title>Email - <?php echo $emailData['title']; ?></title>
        ...
        <div class="col overflow-auto vh-100">
          ...
          <div>
            <div class="container mt-4">
              <a href="/admin/users_section/emails/" class="btn btn-primary mb-3 fw-medium rounded-pill"><i class="bi bi-arrow-left"></i> Back</a>
              <div class="mt-4">
                  ...
                  <div class="d-flex align-items-start">
                    ...
                    <div class="flex-grow-1">
                      <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                          <h5 class="mb-1 fw-bold"><?php echo $sender_artist; ?> <?php if ($sender_id == 1) echo '<small>(Owner)</small>'; ?></h5>
                          <small class="text-muted">&lt;<?php echo $emailData['email']; ?>&gt;</small><br>
                          <small class="text-muted">Recipient: <?php echo $emailData['to_email']; ?></small>
                          <small class="text-muted"><?php echo date("d M Y, H:i", strtotime($emailData['date'])); ?></small>
                        </div>
                      </div>
                      <h5 class="mb-3 mt-5 fw-bold"><?php echo $emailData['title']; ?></h5>
                      <?php
