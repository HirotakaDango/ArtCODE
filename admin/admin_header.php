        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
          <div class="position-sticky pt-3 sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold <?php if(basename($_SERVER['PHP_SELF']) == 'index.php') echo 'fs-4 ' ?>" href="index.php">
                  <span class="align-text-bottom"></span>
                  <i class="bi bi-diagram-3-fill"></i> Dashboard
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold <?php if(basename($_SERVER['PHP_SELF']) == 'edit_users.php') echo 'fs-4' ?>" href="edit_users.php">
                  <span class="align-text-bottom"></span>
                  <i class="bi bi-people-fill"></i> All Users
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold <?php if(basename($_SERVER['PHP_SELF']) == 'remove_images.php') echo 'fs-4' ?>" href="remove_images.php">
                  <span class="align-text-bottom"></span>
                  <i class="bi bi-images"></i> All Images
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold <?php if(basename($_SERVER['PHP_SELF']) == 'remove_all.php') echo 'fs-4' ?>" href="remove_all.php">
                  <span class="align-text-bottom"></span>
                  <i class="bi bi-person-fill-exclamation"></i> Danger Zone
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-nav fw-bold <?php if(basename($_SERVER['PHP_SELF']) == 'update_news.php') echo 'fs-4' ?>" href="update_news.php">
                  <span class="align-text-bottom"></span>
