...
<html>
  <head>
    <title>Edit Album <?php echo $album_name; ?></title>
    <meta charset="UTF-8"> 
    ...
    <div class="container mt-3">
      ...
      <form method="post">
        <div class="form-floating mb-3">
          <input type="text" class="form-control rounded-3 border text-secondary fw-bold border-4" id="new_album_name" name="new_album_name" value="<?php echo $album_name; ?>" maxlength="40">
          <label for="floatingInput" class="text-secondary fw-bold">Update new album name</label>
        </div>
        <div class="container">
