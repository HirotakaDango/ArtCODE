...
<html>
  ...
  <body>
    ...
    <button type="button" class="btn btn-primary position-fixed bottom-0 end-0 me-3 mb-3 fw-bold" data-bs-toggle="modal" data-bs-target="#createAlbum">
      ...
      ?>
          <div class="image-container">
            <div class="position-relative">
              ...
              ?>
                <a class="d-block" href="album_images.php?album=<?= urlencode($album_id) ?>"><img data-src="<?= $thumbnail_path ?>" class="lazy-load shadow" alt="Album Image"></a>
              <?php
                } else {
              ?>
                <a class="d-block" href="album_images.php?album=<?= urlencode($album_id) ?>"><img data-src="icon/bg.png" class="lazy-load shadow"></a>
              <?php
              } ?>
              ...
              <button class="fw-bold position-absolute ms-1 mb-1 bottom-0 btn btn-sm btn-secondary opacity-75 disabled" style="word-wrap: break-all;"><?= substr($album_name, 0, 13) ?></button>
            </div>
          </div>
        <?php }
      } ?>
