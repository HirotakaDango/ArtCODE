                ...
                <div class="card h-100 shadow-sm">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a class="btn btn-sm btn-outline-secondary" href="album_images.php?album=<?= urlencode($album_id) ?>"><i class="bi bi-eye-fill"></i></a>
                        <a class="btn btn-sm btn-outline-secondary" href="edit_album.php?album=<?php echo $album_name; ?>"><i class="bi bi-pencil-fill"></i></a>
                        <input type="hidden" name="delete_album" value="<?= $album_name ?>">
                        <button class="btn btn-sm btn-outline-secondary rounded-start-0" onclick="return confirm('Are you sure?')" type="submit"><i class="bi bi-trash-fill"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
