      ...
      <div class="roow">
        <div class="cool-6">
          <div class="caard container">
            <img src="<?php echo !empty($current_pic) ? $current_pic : "icon/bg.png"; ?>" alt="Current Profile Picture" class="img-thumbnail" style="width: 100%; height: 300px; object-fit: cover;">
          </div>
        </div>
        <div class="cool-6">
          <div class="caard container">
