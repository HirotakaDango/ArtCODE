        ...
        <div class="image-container">
          <div class="position-relative">
            <a class="shadow rounded imageA" href="image.php?artworkid=<?php echo $image['id']; ?>">
              <img class="imageI lazy-load <?php echo ($image['type'] === 'nsfw') ? 'nsfw' : ''; ?>" data-src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $image['filename']; ?>" alt="<?php echo $image['title']; ?>">
            </a> 
