      ...
      <div class="roow">
        <div class="cool-6">
          ...
          <div class="caard position-relative">
            <a href="#" id="originalImageLink" data-bs-toggle="modal" data-bs-target="#originalImageModal" data-original-src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>">
              <img class="img-pointer rounded-r h-100 w-100" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?= $image['filename'] ?>" alt="<?php echo $image['title']; ?>">
            </a>
                    ...
                    <div class="position-relative h-100 w-100 align-items-center">
                      ...
                      <div class="image-container position-relative">
                        <div class="btn-group position-absolute bottom-0 end-0 m-3">
                          <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>" class="btn btn-sm btn-dark rounded-3 rounded-end-0 opacity-75 fw-bold" download>
                            <i class="bi bi-cloud-arrow-down-fill"></i> <small>download</small>
                          </a>
                          <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>" class="btn btn-sm btn-dark rounded-3 rounded-start-0 opacity-75 fw-bold">
                      ...
                      <?php foreach ($child_images as $child_image) : ?>
                        <div class="image-container position-relative">
                          <img data-src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $child_image['filename']; ?>" class="mb-1 lazy-load" style="height: 100%; width: 100%;" alt="<?php echo $image['title']; ?>">
                          <div class="card-img-overlay position-absolute bottom-0 start-0 m-3">
                            <h6 class="card-title text-white fw-bold shadowed-text">
                              <?php echo $image['title']; ?>          
                            </h6>
                          ...
                          <div class="btn-group position-absolute bottom-0 end-0 m-3">
                            <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $child_image['filename']; ?>" class="btn btn-sm btn-dark rounded-3 rounded-end-0 opacity-75 fw-bold" download>
                              <i class="bi bi-cloud-arrow-down-fill"></i> <small>download</small>
                            </a>
                            <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $child_image['filename']; ?>" class="btn btn-sm btn-dark rounded-3 rounded-start-0 opacity-75 fw-bold">
                              <i class="bi bi-arrows-fullscreen text-stroke"></i>
                            </a>
                          </div>
                        </div>
                          ...
                          <?php
                            ...
                            <div class="media-elementF d-inline-flex">
                              <a href="image.php?artworkid=<?php echo $image_idF; ?>">
                                <img class="hori <?php echo ($image_idF == $current_image_idF) ? 'opacity-50' : ''; ?>" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $image_urlF; ?>" alt="<?php echo $image_titleF; ?>">
                              </a>
                            </div>
                          <?php $count++; ?>
                              ...
                              <?php foreach ($images as $index => $imageU): ?>
                                ...
                                <div class="carousel-item <?php echo $active_class; ?>">
                                  <a href="image.php?artworkid=<?php echo $image_id; ?>">
                                    <img class="lazy-load d-block w-100 rounded object-fit-cover img-UF" style="object-position: top;" data-src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $image_url; ?>" alt="<?php echo $image_title; ?>">
                          ...
                          <div class="d-flex justify-content-center">
                            <div class="w-98 fw-bold">
                              <div class="btn-group mb-3 w-100">
                                ...
                                <a class="btn btn-sm btn-outline-light rounded-0 rounded-end-0 fw-bold" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>">
                                  ...
                                  <?php foreach ($images as $index => $image) { ?>
                                    <div class="text-white mt-3 mb-3 rounded border border-1 border-light">
                                      <ul class="list-unstyled m-1">
                                        ...
                                        <li class="mb-2">
                                          <a class="text-decoration-none text-primary" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>">
                                            <i class="bi bi-arrows-fullscreen text-stroke"></i> View original image
                                          </a>
                                        </li>
                                        <li>
                                          <a class="text-decoration-none text-primary" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>" download>
                                  ...
                                  <?php foreach ($image_childs as $index => $image_child) { ?>
                                    <div class="text-white mt-3 mb-3 rounded border border-1 border-light">
                                      <ul class="list-unstyled m-1">
                                        ...
                                        <li class="mb-2"><i class="bi bi-calendar"></i> Image date: <?php echo date('Y/m/d', strtotime($image['date'])); ?></li>
                                        <li class="mb-2">
                                          <a class="text-decoration-none text-primary" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image_child['filename']; ?>">
                                            <i class="bi bi-arrows-fullscreen text-stroke"></i> View original image
                                          </a>
                                        </li>
                                        <li>
                                          <a class="text-decoration-none text-primary" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image_child['filename']; ?>" download>
                                            <i class="bi bi-cloud-arrow-down-fill"></i> Download original image
                                          </a>
                                        </li>
                                      </ul>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                  <div class="modal-content">
                    ...
                    <div class="modal-body scrollable-div">
                      <a class="btn btn-outline-dark fw-bold w-100 mb-2 text-center rounded-3" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>" download>
          ...
          <div class="d-none d-md-block d-lg-block">
            <div class="collapse" id="collapseCompression1">
              <div class="alert alert-warning fw-bold rounded-4">
                <small><p>first original image have been compressed to <?php echo round($reduction_percentage, 2); ?>%</p> (<a class="text-decoration-none" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>">click to view original image</a>)</small>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container d-md-none d-lg-none">
            <div class="collapse" id="collapseCompression1">
              <div class="alert alert-warning fw-bold rounded-3">
                <small>first original image have been compressed to <?php echo round($reduction_percentage, 2); ?>% (<a class="text-decoration-none" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/images/<?php echo $image['filename']; ?>">click to view original image</a>)</small>
              </div>
            </div>
          </div>
            ...
            <div class="me-2 ms-2 rounded fw-bold">
              <div class="d-flex d-md-none d-lg-none gap-2">
                <?php if ($next_image): ?>
                  <a class="image-containerA shadow rounded" href="image.php?artworkid=<?= $next_image['id'] ?>">
                    <div class="position-relative">
                      <img class="img-blur object-fit-cover rounded opacity-75" style="width: 100%; height: 120px;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $next_image['filename']; ?>" alt="<?php echo $next_image['title']; ?>">
                ...
                <a class="image-containerA shadow rounded" href="image.php?artworkid=<?= $image['id'] ?>">
                  <img class="object-fit-cover opacity-50 rounded" style="width: 100%; height: 120px;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?= $image['filename'] ?>" alt="<?php echo $image['title']; ?>">
                </a>
                <?php if ($prev_image): ?>
                  <a class="image-containerA shadow rounded" href="image.php?artworkid=<?= $prev_image['id'] ?>">
                    <div class="position-relative">
                      <img class="img-blur object-fit-cover rounded opacity-75" style="width: 100%; height: 120px;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $prev_image['filename']; ?>" alt="<?php echo $prev_image['title']; ?>">
                      <h6 class="fw-bold shadowed-text text-white position-absolute top-50 start-50 translate-middle">
              ...
              <div class="d-none d-md-flex d-lg-flex mt-2 gap-2">
                <?php if ($next_image): ?>
                  <a class="image-containerA shadow rounded" href="image.php?artworkid=<?= $next_image['id'] ?>">
                    <div class="position-relative">
                      <img class="img-blur object-fit-cover rounded opacity-75" style="width: 100%; height: 160px;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $next_image['filename']; ?>" alt="<?php echo $next_image['title']; ?>">
                      <h6 class="fw-bold shadowed-text text-white position-absolute top-50 start-50 translate-middle">
                        <i class="bi bi-arrow-left-circle text-stroke"></i> Next
                      </h6>
                    </div>
                ...
                <?php endif; ?>
                <a class="image-containerA shadow rounded" href="image.php?artworkid=<?= $image['id'] ?>">
                  <img class="object-fit-cover opacity-50 rounded" style="width: 100%; height: 160px;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?= $image['filename'] ?>" alt="<?php echo $image['title']; ?>">
                </a>
                <?php if ($prev_image): ?>
                  <a class="image-containerA shadow rounded" href="image.php?artworkid=<?= $prev_image['id'] ?>">
                    <div class="position-relative">
                      <img class="img-blur object-fit-cover rounded opacity-75" style="width: 100%; height: 160px;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $prev_image['filename']; ?>" alt="<?php echo $prev_image['title']; ?>">
                      <h6 class="fw-bold shadowed-text text-white position-absolute top-50 start-50 translate-middle">
                        Prev <i class="bi bi-arrow-right-circle text-stroke"></i>
                      </h6>
                    </div>
