                    ...
                    <div class="modal-content border-0">
                      <div class="modal-body p-0">
                        ...
                        <div class="modal-body p-0">
                          ...
                          <div class="row g-0">
                            <div id="div1_<?php echo $row['id']; ?>" class="overflow-auto col-md-7 h-100 scrollable-div">
                              <div>
                                <a href="/image.php?artworkid=<?php echo $row['id']; ?>">
                                  <img class="object-fit-cover shadow lazy-load h-100 w-100" data-src="/thumbnails/<?php echo $row['filename']; ?>" alt="<?php echo $row['title']; ?>">
                                </a>
                              </div>
                            </div>
                            <div id="div2_<?php echo $row['id']; ?>" class="overflow-auto col-md-5 h-100 scrollable-div">
                              <div class="p-3">
                                <h5 class="text-center fw-bold my-4"><?= $row['title']; ?></h5>
                                ...
                                <div class="btn-group mt-2 w-100">
                                  ...
                                  <a href="/image.php?artworkid=<?php echo $row['id']; ?>" class="btn btn-sm border-0"><i class="bi bi-eye-fill"></i></a>
                                </div>
                                    ...
                                    <?php
                                      ...
                                      echo "<div class='mb-3 row'>
                                              <label for='' class='col-sm-4 col-form-label text-nowrap fw-medium'>Image ID</label>
                                                <div class='col-sm-8'>
                                                  <input type='text' class='form-control-plaintext fw-bold' id='' value='" . $row['id'] . "' readonly>
                                                </div>
                                            </div>";
                                      ...
                                      echo "<p class='text-start fw-medium'><a class='text-decoration-none' href='" . $base_url . $row['filename'] . "'>View original image</a></p>";
