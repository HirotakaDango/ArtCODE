                <!-- Modal -->
                <div class="modal fade" id="infoImage_<?php echo $image_idP; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              <div class="card border-0 rounded-4 overflow-auto scrollable-div" style="max-height: 250px;">
                                <a class="w-100 h-100" href="image.php?artworkid=<?php echo $imageP['id']; ?>">
                                  <img class="rounded-4 object-fit-cover shadow lazy-load" height="400" width="100%" data-src="thumbnails/<?php echo $image_urlP; ?>" alt="<?php echo $imageP['title']; ?>">
                                </a>
                              </div>
