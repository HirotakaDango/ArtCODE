  ...
  <body>
    ...
    <script>
      function showPreview(event) {
        ...
        container.innerHTML = "";
        var imgHeight = window.innerWidth < 768 ? (event.target.files.length > 1 ? 200 : 400) : (event.target.files.length > 2 ? 212 : 424);
      ...
      function displayMetadata(file) {
        ...
        fileTypeElement.textContent = "File Type: " + fileType;
        ...
        imageDateElement.textContent = "Image Date: " + formatDate(file.lastModifiedDate);
        ...
        img.onload = function() {
          ...
          imageResolutionElement.textContent = "Image Resolution: " + this.naturalWidth + "x" + this.naturalHeight;
