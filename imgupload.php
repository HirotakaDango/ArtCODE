...
<html lang="en">
  ...
  <body>
    ...
    <section class="gallery-links">
      <center>
        <div class="container">
          <h2 class="mt-3 mb-3" style="font-family: sans-serif; float: center; color: gray; font-weight: 800;">UPLOAD IMAGE</h2>
          <img id="file-ip-1-preview" style="height: 350px; border-radius: 8px; width: 100%; margin-bottom: 15px;">
          <div class="gallery-upload">
            <form action="upload.php" method="post" enctype="multipart/form-data">
              ...
              <input class="form-control mt-3" type="text" name="title" placeholder="Enter title for your image"> 
              <input class="form-control mt-3" type="text" name="imgdesc" placeholder="Enter description for your image">
              <input class="form-control mt-3" type="text" name="tags" placeholder="Enter tags separated by comma">
              <input class="form-control mt-3" type="text" name="link" placeholder="Enter link for your image"> 
