      ...
      <div class="caard container">
        <form action="upload.php" method="post" enctype="multipart/form-data">
          <div id="drop-zone" class="drop-zone fw-bold text-secondary mb-2 rounded-3 border-4 text-center">
            <label for="file-ip-1">
              <div class="d-flex flex-column align-items-center"> <!-- Wrap the content in a flex container -->
                <div class="mb-4 mt-2">
    ...
    <script>
      ...
      function showPreview(event) {
        ...
        for (var i = 0; i < event.target.files.length; i++) {
          ...
          img.style.height = window.innerWidth >= 768 ? "150px" : (event.target.files.length > 1 ? "200px" : "400px");
