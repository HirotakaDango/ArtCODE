        ...
        <div class="offcanvas offcanvas-start w-50" tabindex="-1" id="navbar" aria-labelledby="navbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-bold">
              ...
              <li class="nav-item">
                <a class="nav-link nav-center active" href="imgupload.php">
        ...
        <div class="cool-6">
          <div class="caard container">
            <form action="upload.php" method="post" enctype="multipart/form-data">
              ...
              <input class="form-control mt-3" type="text" name="link" placeholder="Enter link for your image" maxlength="120" required> 
