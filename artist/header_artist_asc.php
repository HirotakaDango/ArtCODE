        ...
        <?php
          try {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
              ...
              echo "<a class='fw-medium btn btn-sm btn-dark rounded-pill' style='margin-right: 2px;' href='?id=$id&by=tagged_oldestt&tag=$firstTag'><i class='bi bi-tags-fill'></i> $firstTag</a>";
            }
