    <div class="overflow-x-auto container-fluid p-1 mb-2 hide-scrollbar" style="white-space: nowrap;">
      <a href="?id=<?php echo $id; ?>&by=newest&page=<?php echo isset($_GET['page']) ? $_GET['page'] : '1'; ?>" class="fw-medium btn btn-sm btn-dark rounded-pill">all images</a>
        <?php
          try {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
              ...
              echo "<a class='fw-medium btn btn-sm btn-dark rounded-pill' style='margin-right: 2px;' href='?id=$id&by=tagged_newest&tag=$firstTag'><i class='bi bi-tags-fill'></i> $firstTag</a>";
            }
