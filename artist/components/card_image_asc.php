                            ...
                            <div id="div2_<?php echo $imageA['id']; ?>" class="overflow-auto col-md-5 h-100 scrollable-div">
                              <div class="p-3">
                                ...
                                <div class="collapse mt-2" id="collapseDownload">
                                  <a class="btn btn-primary fw-bold rounded-4 w-100" href="#" onclick="downloadWithProgressBar(<?php echo $imageA['id']; ?>, '<?php echo $imageA['title']; ?>')">
                                    <i class="bi bi-download text-stroke"></i> download all images (<?php echo $total_image_size; ?> MB)
                                  </a>
                                  <div class="progress fw-bold mt-2 rounded-4" id="progressBarContainer_<?php echo $imageA['id']; ?>" style="height: 30px; display: none;">
                                    <div id="progressBar_<?php echo $imageA['id']; ?>" class="progress-bar progress-bar progress-bar-animated fw-bold" style="width: 0; height: 30px;">0%</div>
                                  </div>
                                  <script>
                                  ...
                                  <p class="fw-bold text-center container">
                                    <small>2. If you found download error or failed, <a class="text-decoration-none" href="/download_images.php?artworkid=<?php echo $imageA['id']; ?>">click this link</a> for third option if download all images error or failed.</small>
                                  </p>
                                  <p class="fw-bold text-center container">
