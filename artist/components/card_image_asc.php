                        ...
                        <div class="card container rounded-5 p-3 position-relative" style="max-width: 750px;">
                          ...
                          <div class="row d-flex justify-content-center">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              ...
                              <div class="btn-group mt-2 w-100">
                                ...
                                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/image.php?artworkid=<?php echo $imageA['id']; ?>" class="btn btn-sm border-0"><i class="bi bi-eye-fill"></i></a>
                              </div>
                          ...
                          <div class="overflow-auto" style="max-height: 250px;">
                            ...
                            <div class="collapse mt-2" id="collapseInfoDesktop">
                              <div class="card rounded-4 container">
                                ...
                                <?php
                                  ...
                                  $image_size = round(filesize($imageA_folder_path . $imageA['filename']) / (1024 * 1024), 2);
                                  $total_image_size += $image_size;
                                  list($width, $height) = getimagesize($imageA_folder_path . $imageA['filename']);
                                  ...
                                  echo "<p class='text-start fw-semibold'><a class='text-decoration-none' href='" . $base_url . $imageA['filename'] . "'>View original image</a></p>";
                                  ...
                                  while ($child_image = $child_images_result->fetchArray()) {
                                    $child_image_size = round(filesize($imageA_folder_path . $child_image['filename']) / (1024 * 1024), 2);
                                    $total_image_size += $child_image_size;
                                    list($child_width, $child_height) = getimagesize($imageA_folder_path . $child_image['filename']);
                            ...
                            <div class="collapse mt-2" id="collapseDownload">
                              ...
                              <p class="fw-bold text-center container">
                                <small>2. If you found download error or failed, <a class="text-decoration-none" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/download_images.php?artworkid=<?php echo $imageA['id']; ?>">click this link</a> for third option if download all images error or failed.</small>
                              </p>
                              <p class="fw-bold text-center container">
