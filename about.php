  <div class="container">
    <div class="rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">Why ArtCODE?</h1>
        <p class="col-md-8 fs-5 text-secondary fw-bold">ArtCODE is an online platform that combines the best features of Pixiv and Pinterest to create a unique and immersive experience for artists and art enthusiasts alike. Whether you're a seasoned professional or a budding beginner, ArtCODE provides a welcoming community where you can showcase your talent and connect with like-minded individuals from all over the world.</p>
      </div>
    </div>
    <div class="row mb-5">
