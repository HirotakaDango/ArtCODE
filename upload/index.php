  ...
  <body>
    ...
    <script>
      ...
      function showSuccessMessage() {
        ...
        btnGroupDiv.classList.add('btn-group', 'my-4', 'w-100');

        var profileLink = document.createElement('a');
        profileLink.classList.add('btn', 'btn-primary', 'fw-bold');
        profileLink.href = '../profile.php';
        profileLink.textContent = 'Go to Profile';

        var homeLink = document.createElement('a');
        homeLink.classList.add('btn', 'btn-primary', 'fw-bold');
        homeLink.href = '../index.php';
        homeLink.textContent = 'Go to Home';

        btnGroupDiv.appendChild(profileLink);
        btnGroupDiv.appendChild(homeLink);

        successContainer.appendChild(alertContainer);
        successContainer.appendChild(btnGroupDiv);
