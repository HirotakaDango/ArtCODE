...
<div class="w-100 px-1 mb-4">
  <a class="btn bg-body-secondary rounded-pill border-0 w-100 mt-3 fw-bold link-body-emphasis" href="/rankings/?by=<?php if(!isset($_GET['time']) || $_GET['time'] == 'day') echo 'day'; ?>">View More</a>
</div>