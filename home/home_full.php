    ...
    <script>
      function adjustDisplay() {
        ...
        if (isMobile && currentDisplay !== 'mobile') {
          ...
          window.location.href = "/home/?" + "<?php echo http_build_query(array_merge($_GET, ['display' => 'mobile'])); ?>";
        } else if (!isMobile && currentDisplay !== 'desktop') {
          // Redirect to desktop view if not already on desktop view
          window.location.href = "/home/?" + "<?php echo http_build_query(array_merge($_GET, ['display' => 'desktop'])); ?>";
        }
