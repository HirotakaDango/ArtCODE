    ...
    <div class="d-flex justify-content-end">
      <div class="px-1 overflow-auto text-nowrap">
        <a href="javascript:void(0);" id="full-homepage-button" class="btn fw-medium btn-sm btn-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/opposite.php'); ?> rounded-pill <?php if (isset($_GET['option']) && $_GET['option'] == 'full') echo 'active'; ?>">full homepage</a>
        <a href="javascript:void(0);" id="simple-homepage-button" class="btn fw-medium btn-sm btn-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/opposite.php'); ?> rounded-pill <?php if (!isset($_GET['option']) || $_GET['option'] == 'simple') echo 'active'; ?>">simple homepage</a>
      </div>
    </div>
