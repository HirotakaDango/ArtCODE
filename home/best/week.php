  ...
  <div class="position-relative w-100 h-100 d-flex align-items-center justify-content-center">
    <div class="container px-0">
      <div id="imageCarouselUser" class="carousel slide" data-bs-ride="carousel">
        <h5 class="fw-bold text-white" style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4), 2px 2px 4px rgba(0, 0, 0, 0.3), 3px 3px 6px rgba(0, 0, 0, 0.2);">Popular Images This Week</h5>
