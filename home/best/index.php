...
<div class="container-fluid">
  <div class="position-absolute top-0 end-0 z-2 pe-5 pt-5 mt-5">
    ...
    <div class="d-flex mt-4 pt-2">
      <a class="btn border-0 p-0 ms-auto text-white link-body-emphasis" href="/rankings/?by=<?php if(!isset($_GET['time']) || $_GET['time'] == 'day') echo 'day'; ?>" style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4), 2px 2px 4px rgba(0, 0, 0, 0.3), 3px 3px 6px rgba(0, 0, 0, 0.2);">view more <i class="bi bi-chevron-right"></i></a>
    </div>
  </div>
</div>
