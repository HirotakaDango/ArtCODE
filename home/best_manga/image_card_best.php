  ...
  <div class="position-relative w-100 h-100 d-flex align-items-center justify-content-center">
    <div class="container-fluid px-5">
      <div id="imageCarouselManga" class="carousel slide" data-bs-ride="carousel">
        <h5 class="fw-bold text-white" style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4), 2px 2px 4px rgba(0, 0, 0, 0.3), 3px 3px 6px rgba(0, 0, 0, 0.2);">Popular Manga</h5>
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content bg-transparent border-0">
                          <div class="modal-body position-relative">
                            <a class="position-absolute top-0 end-0 m-4 text-white" href="/artist.php?id=<?php echo urlencode($user_idManga); ?>" target="_blank">
