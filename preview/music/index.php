...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid text-white">
      ...
      <button class="btn btn-outline-dark rounded-5 d-md-none w-100 fw-bold mt-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePopularMobile" aria-expanded="false" aria-controls="collapseExample">
