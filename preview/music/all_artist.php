...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid d-flex">
      ...
      <div class="dropdown mt-3 me-auto <?php echo ((isset($_GET['by']) && ($_GET['by'] === 'newest_lists' || $_GET['by'] === 'oldest_lists' || $_GET['by'] === 'popular_lists' || $_GET['by'] === 'desc_lists' || $_GET['by'] === 'asc_lists')) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_desc_lists.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_asc_lists.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_pop_lists.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_order_asc_lists.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_order_desc_lists.php') !== false)) ? 'd-none' : ''; ?>">
      ...
      <div class="dropdown mt-3 me-auto <?php echo ((isset($_GET['by']) && ($_GET['by'] === 'newest' || $_GET['by'] === 'oldest' || $_GET['by'] === 'popular' || $_GET['by'] === 'desc' || $_GET['by'] === 'asc')) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_desc_grid.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_asc_grid.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_pop_grid.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_order_asc_grid.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_order_desc_grid.php') !== false)) ? 'd-none' : ''; ?>">
        <button class="btn btn-sm fw-bold rounded-pill mb-2 btn-outline-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
          <i class="bi bi-images"></i> sort by
        </button>
        <ul class="dropdown-menu">
    ...
    <div class="container-fluid">
        ...
        if(isset($_GET['by'])){
          ...
          switch ($sort) {
            // grid layout
            case 'newest':
            include "all_artist_desc_grid.php";
            break;
            case 'oldest':
            include "all_artist_asc_grid.php";
            break;
            case 'popular':
            include "all_artist_pop_grid.php";
            break;
            case 'asc':
            include "all_artist_order_asc_grid.php";
            break;
            case 'desc':
            include "all_artist_order_desc_grid.php";
            break;
            // vertical lists layout
            case 'newest_lists':
            include "all_artist_desc_lists.php";
            break;
            case 'oldest_lists':
            include "all_artist_asc_lists.php";
            break;
            case 'popular_lists':
            include "all_artist_pop_lists.php";
            break;
            case 'asc_lists':
            include "all_artist_order_asc_lists.php";
            break;
            case 'desc_lists':
            include "all_artist_order_desc_lists.php";
            break;
          }
        }
        else {
