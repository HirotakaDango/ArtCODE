...
?>
      ...
      <div class="d-none d-md-block">
                    ...
                    <div class="shadow-sm position-relative rounded-3 h-100">
                      <div class="card border-0 position-relative">
                        <a class="shadow position-relative btn p-0" href="album.php?mode=<?php echo isset($_GET['mode']) ? $_GET['mode'] : 'grid'; ?>&album=<?php echo $row['album']; ?>">
                          <img class="h-100 w-100 object-fit-cover rounded" src="/feeds/music/covers/<?php echo $row['cover']; ?>">
        ...
        <div class="d-flex justify-content-center align-items-center mt-2">
          <button class="btn border-0 link-body-emphasis me-auto" type="button" data-bs-target="#carouselAlbum" data-bs-slide="prev">
            <i class="bi bi-arrow-left text-stroke fs-4"></i>
          </button>
          <button class="btn border-0 link-body-emphasis ms-auto" type="button" data-bs-target="#carouselAlbum" data-bs-slide="next">
