                            ...
                            <div id="div2_<?php echo $imageL['id']; ?>" class="overflow-auto col-md-5 h-100 scrollable-div">
                              <div class="p-3">
                                ...
                                <div class="btn-group mt-2 w-100">
                                  <a class="btn btn-sm border-0" data-bs-toggle="collapse" href="#shareSection_<?php echo $imageL['id']; ?>" role="button" aria-expanded="false" aria-controls="collapseExample"><i class="bi bi-share-fill icon-stroke-1"></i></a>
                                  <button class="btn btn-sm fw-bold border-0"><i class="bi bi-bar-chart-line-fill"></i> <?php echo $imageL['view_count']?></button>
                                  <button class="btn btn-sm border-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseInfoDesktop_<?php echo $imageL['id']; ?>" aria-expanded="false" aria-controls="collapseExample"><i class="bi bi-info-circle-fill"></i></button>
                                  <button class="btn btn-sm border-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDownload_<?php echo $imageL['id']; ?>" aria-expanded="false" aria-controls="collapseExample"><i class="bi bi-download icon-stroke-1"></i></button>
                                  <a href="/image.php?artworkid=<?php echo $imageL['id']; ?>" class="btn btn-sm border-0"><i class="bi bi-eye-fill"></i></a>
                                </div>
                                <div class="collapse" id="shareSection_<?php echo $imageL['id']; ?>">
                                ...
                                <div class="collapse mt-2" id="collapseInfoDesktop_<?php echo $imageL['id']; ?>">
                                  <div class="card rounded-4 container">
                                    ...
                                    <?php
                                      ...
                                      $imageA_path = $imageA_folder_path . $imageL['filename'];
                                      ...
                                      $child_images_query->execute(['id' => $imageL['id']]);
                                ...
                                <div class="collapse mt-2" id="collapseDownload_<?php echo $imageL['id']; ?>">
                                  <a class="btn btn-primary fw-bold rounded-4 w-100" href="/download_images.php?artworkid=<?php echo $imageL['id']; ?>" target="_blank">
                                  ...
                                  <p class="fw-bold text-center container">
                                    <small>2. If you found download error or failed, <a class="text-decoration-none" href="/download_batch.php?artworkid=<?php echo $imageL['id']; ?>">click this link</a> for third option if download all images error or failed.</small>
                                  </p>
                                  <p class="fw-bold text-center container">
