            ...
            <div class="me-2 ms-2 rounded fw-bold">
              ...
              <?php if (isset($image['episode_name']) && !empty($image['episode_name'])): ?>
                <div class="btn-group gap-2 w-100 my-2">
                  <a class="btn btn-dark fw-bold rounded-4 w-50" target="_blank" href="/preview/manga/title.php?title=<?php echo urlencode($image['episode_name']); ?>&uid=<?php echo $user['id']; ?>">
                    <small>go to manga</small>
                  </a>
                  <a class="btn btn-dark fw-bold rounded-4 w-50" target="_blank" href="/preview/manga/view.php?title=<?php echo urlencode($image['episode_name']); ?>&uid=<?php echo $user['id']; ?>&id=<?php echo $image['id']; ?>&page=1">
              ...
              <a class="btn btn-dark rounded-4 mt-2 fw-bold w-100" style="word-wrap: break-word;" href="/preview/artist.php?by=newest&id=<?= $user['id'] ?>">
                <small>
