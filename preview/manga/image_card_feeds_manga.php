            ...
            <div class="col">
              <div class="card border-0 rounded-4">
                <a href="title.php?title=<?= urlencode($image['episode_name']); ?>&uid=<?= $image['userid']; ?>" class="text-decoration-none">
                  ...
                  <h6 class="text-center fw-bold text-dark text-decoration-none bg-dark-subtle p-2 rounded rounded-top-0" id="episode-name_img<?= $image['id']; ?>_<?= $image['userid']; ?>">「<?= $image['artist']; ?>」<?= $image['episode_name']; ?> 「<?= $image['language']; ?>」</h6>
                </a>
              </div>
            </div>
            <style>
