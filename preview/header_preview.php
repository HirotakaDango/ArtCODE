        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar" aria-labelledby="navbarLabel">
          ...
          <div class="offcanvas-body">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-bold d-md-none d-lg-none">
              ...
              <div class="btn-group gap-2 w-100 mt-2">
                <a class="btn bg-body-tertiary border-0 link-body-emphasis rounded-4 fw-bold p-3 w-50 d-flex justify-content-center align-items-center text-center flex-column <?php if (basename($_SERVER['PHP_SELF']) == 'index.php' && strpos($_SERVER['PHP_SELF'], '/preview/manga/') !== false) echo 'opacity-75 shadow'; ?>" data-bs-toggle="collapse" href="#collapseManga" role="button" aria-expanded="false" aria-controls="collapseExample">
              ...
              <div class="collapse mt-2" id="collapseManga">
                <div class="card card-body rounded-4 border-0 bg-body-tertiary">
                  <div class="btn-group-vertical gap-2">
                    <form action="/preview/manga/" method="GET" class="my-3 w-100">
                      <div class="input-group">
                    ...
                    <a class="text-start btn bg-body-tertiary link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga">Home</a>
                    <a class="text-start btn bg-body-tertiary link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/artists.php">Artists</a>
                    <a class="text-start btn bg-body-tertiary link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/tags.php">Tags</a>
                    <a class="text-start btn bg-body-tertiary link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/groups.php">Groups</a>
                    <a class="text-start btn bg-body-tertiary link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/parodies.php">Parodies</a>
                    <a class="text-start btn bg-body-tertiary link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/characters.php">Characters</a>
                  </div>
                </div>
              </div>
    ...
    <div class="modal fade" id="modalCollapseManga" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content rounded-4 border-0">
          ...
          <div class="modal-body">
            <div class="card-body">
              <form action="/preview/manga/" method="GET" class="mb-3">
                <div class="input-group">
                  <input type="text" name="q" class="form-control text-lowercase fw-bold rounded-end-0 rounded-4 border-0 bg-body-tertiary" placeholder="Search">
                  <button type="submit" class="btn bg-body-tertiary link-body-emphasis border-0 rounded-start-0 rounded-4"><i class="bi bi-search" style="-webkit-text-stroke: 1px;"></i></button>
                </div>
              </form>
              <div class="btn-group-vertical gap-2">
                <a class="text-start btn link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga">Home</a>
                <a class="text-start btn link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/artists.php">Artists</a>
                <a class="text-start btn link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/tags.php">Tags</a>
                <a class="text-start btn link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/groups.php">Groups</a>
                <a class="text-start btn link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/parodies.php">Parodies</a>
                <a class="text-start btn link-body-emphasis rounded-4 w-100 border-0 fw-bold" href="/preview/manga/characters.php">Characters</a>
              </div>
            </div>
          </div>
        </div>
