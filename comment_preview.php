      ...
      <div class="fixed-bottom w-100">
        <form action="" method="POST">
          <div class="input-group w-100">
            <textarea id="message-input" name="comment" class="form-control rounded-top-0 rounded-bottom-1 rounded-end-0 fw-semibold border-start-0 border-bottom-0" style="height: 40px; max-height: 150px;" placeholder="Type your comment..." aria-label="Type a message..." aria-describedby="basic-addon2" 
            ...
            <button type="submit" class="btn btn-primary rounded-top-0 rounded-bottom-0 fw-bold">send</button>
          </div>
        </form> 
      </div>
    </div>
