          ...
          <div class="modal-body">
            ...
            <div class="modal-body p-4 pt-0">
              <form class="" action="session_code.php" method="post">
                ...
                <p class="text-secondary fw-bold">Having a trouble with your <a class="text-primary" data-bs-target="#help" data-bs-toggle="modal">account</a>?</p>
              </form>
            </div>
          </div>
        </div>
          ...
          <div class="modal-body">
            ...
            <div class="modal-body p-4 pt-0">
              <form class="" action="session_code.php" method="post">
                ...
                <p class="text-secondary fw-bold"><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" required> By clicking this, you'll agree with the <a class="text-primary" data-bs-target="#terms" data-bs-toggle="modal">terms of service</a>.</p>
