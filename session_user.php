            ...
            <div class="modal-body p-4 pt-0">
              <form class="" action="session_code.php" method="post">
                <div class="form-floating mb-3">
                  <input name="email" type="email" class="form-control rounded-3" id="floatingInput" maxlength="40" pattern="^[a-zA-Z0-9_@.-]+$" placeholder="name@example.com" required>
                  <label class="fw-bold text-secondary" for="floatingInput">Email address</label>
                </div>
                <div class="form-floating mb-3">
                  ...
                  <label class="fw-bold text-secondary" for="floatingPassword">Password</label>
                </div>
                <div class="form-check mb-3">
                  <input class="form-check-input" type="checkbox" id="remember" name="remember">
                  <label class="form-check-label fw-bold text-secondary" for="remember">Remember Me</label>
                </div>
                ...
                <p class="text-secondary fw-bold">Having a trouble with your <a class="text-primary" data-bs-target="#help" href="#" data-bs-toggle="modal">account</a>?</p>
              </form>
            </div>
          </div>
        </div>
            ...
            <div class="modal-body p-4 pt-0">
              <form class="" action="session_code.php" method="post">
                <div class="form-floating mb-3">
                  ...
                  <label class="fw-bold text-secondary" for="floatingInput">Your name</label>
                </div>
                <div class="form-floating mb-3">
                  <input name="email" type="email" class="form-control rounded-3" id="floatingInput" maxlength="40" pattern="^[a-zA-Z0-9_@.-]+$" placeholder="name@example.com" required>
                  <label class="fw-bold text-secondary" for="floatingInput">Email address</label>
                ...
                <p class="text-secondary fw-bold"><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" required> By clicking this, you'll agree with the <a class="text-primary" href="#" data-bs-target="#terms" data-bs-toggle="modal">terms of service</a>.</p>
