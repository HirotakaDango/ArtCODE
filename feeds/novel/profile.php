...
$queryCount = "SELECT COUNT(*) FROM novel WHERE email IN (SELECT email FROM users WHERE email = :email)";
...
<html data-bs-theme="dark">
  ...
  <body>
    ...
    <?php
      ...
      $user_id_url = $user_id;
      $url = "http://$domain/feeds/novel/user.php?id=$user_id_url";
    ?>
    ...
    <script>
      function shareArtist(userId) {
        ...
        var shareUrl = 'user.php?id=' + userId;
