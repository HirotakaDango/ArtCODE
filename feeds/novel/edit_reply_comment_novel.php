  ...
  if ($reply && $reply['email'] === $_SESSION['email']) {
    ...
    if (isset($_POST['reply'])) {
      ...
      if (!empty($newReply)) {
        ...
        $redirectUrl = 'reply_comment_novel.php?novelid=' . urlencode($novelid) . '&comment_id=' . urlencode($reply['comment_id']);
...
<html lang="en" data-bs-theme="dark">
  ...
  <body>
    ...
    <script>
      function goBack() {
        window.location.href = "reply_comment_novel.php?novelid=<?php echo urlencode($novelid); ?>&comment_id=<?php echo urlencode($reply['comment_id']); ?>";
      }
    </script>
