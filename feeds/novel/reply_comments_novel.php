...
if (isset($_POST['reply_comment_id'], $_POST['reply'])) {
  ...
  if (!empty($reply)) {
    ...
    header('Location: reply_comments_novel.php?novelid='.$novelid.'&comment_id=' . $_POST['reply_comment_id']);
    exit();
  } else {
...
if (isset($_GET['delete_reply_id'])) {
  ...
  if ($reply_info_result !== false) {
    ...
    $redirect_url = 'reply_comments_novel.php?novelid=' . urlencode($novelid) . '&comment_id=' . urlencode($comment_id);
    ...
    <div class="container-fluid mt-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-chevron p-3 bg-body-tertiary rounded-3">
          ...
          <li class="breadcrumb-item">
            <a class="link-body-emphasis fw-semibold text-decoration-none text-white fw-medium" href="view.php?id=<?php echo $novelid; ?>"><?php echo $image['title']; ?></a>
          </li>
          <li class="breadcrumb-item">
            <a class="link-body-emphasis fw-semibold text-decoration-none text-white fw-medium" href="comments.php?novelid=<?php echo $novelid; ?>">Comment ID: <?php echo $comment['id']; ?></a>
          </li>
              ...
              <?php if ($_SESSION['email'] === $reply['email']): ?>
                <form action="" method="get">
                  <div class="btn-group position-absolute top-0 end-0 mt-1 me-1 opacity-50">
                    <a href="edit_reply_comments_novel.php?reply_id=<?php echo $reply['id']; ?>&novelid=<?php echo $novelid; ?>" class="btn btn-sm btn-secondary"><i class="bi bi-pencil-fill"></i></a>
