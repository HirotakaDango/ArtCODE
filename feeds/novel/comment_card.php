        <div class="card border-0 shadow mb-1 position-relative p-2 bg-body-tertiary rounded-4">
          <div class="d-flex align-items-center mb-2 position-relative">
            <div class="position-absolute top-0 start-0 m-1">
              ...
              <a class="text-white text-decoration-none fw-medium link-body-emphasis" href="../../artist.php?id=<?php echo $comment['iduser'];?>" target="_blank"><small>@<?php echo (mb_strlen($comment['artist']) > 15) ? mb_substr($comment['artist'], 0, 15) . '...' : $comment['artist']; ?></small></a>・<small class="small fw-medium"><small><?php echo $comment['created_at']; ?></small></small>
            </div>
          ...
          <div class="m-2 ms-auto">
            <?php
              ...
              $url = "reply_comment_novel.php?sort=$sort&by=$by&novelid=$filename&comment_id=$comment_id&page=$page";
            ?>
