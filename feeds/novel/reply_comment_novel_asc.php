...
if ($comment_id !== null) {
  ...
  $replies = $db->prepare('SELECT rc.*, u.artist, u.pic, u.id as userid FROM reply_comments_novel rc JOIN users u ON rc.email = u.email WHERE rc.comment_id = ? ORDER BY rc.id ASC');
...
?>
    ...
    <div class="container">
      <div>
        ...
        ?>
          <?php include('reply_comment_novel_card.php'); ?>
        <?php endwhile; ?>
      <?php else:
