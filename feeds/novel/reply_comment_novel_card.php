          <div class="card border-0 shadow mb-1 position-relative p-2 bg-body-tertiary rounded-4">
            <div class="d-flex align-items-center mb-2 position-relative">
              <div class="position-absolute top-0 start-0 m-1">
                ...
                <a class="text-white text-decoration-none fw-medium link-body-emphasis" href="../../artist.php?id=<?php echo $reply['userid']; ?>"><small>@<?php echo (mb_strlen($reply['artist']) > 15) ? mb_substr($reply['artist'], 0, 15) . '...' : $reply['artist']; ?></small></a>・<small class="small fw-medium"><small><?php echo $reply['date']; ?></small></small>
              </div>
                ...
                <div class="dropdown ms-auto position-relative">
                  ...
                  <div class="dropdown-menu dropdown-menu-end rounded-4 shadow border-0">
                    <form action="" method="get">
                      <a href="edit_reply_comment_novel.php?sort=<?php echo $replySort; ?>&by=<?php echo $sortUrl; ?>&reply_id=<?php echo $reply['id']; ?>&comment_id=<?php echo $commentId; ?>&novelid=<?php echo $novelid; ?>&page=<?php echo $pageUrl; ?>" class="dropdown-item fw-medium">
                      ...
                      <button onclick="return confirm('Are you sure?')" class="dropdown-item fw-medium" type="submit">
