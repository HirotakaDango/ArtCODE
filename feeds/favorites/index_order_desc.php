...
$query = ("SELECT images.* FROM images INNER JOIN favorites ON images.id = favorites.image_id WHERE favorites.email = '$email' ORDER BY images.title DESC LIMIT $limit OFFSET $offset");
