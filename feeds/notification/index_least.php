...
$stmt = $db->prepare("SELECT images.* FROM images INNER JOIN following ON images.email = following.following_email WHERE following.follower_email = :email ORDER BY images.view_count ASC LIMIT :limit OFFSET :offset");
