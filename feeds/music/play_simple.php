          ...
          <div class="position-relative text-shadow p-3">
            ...
            <div id="music-player" class="w-100">
              <div class="d-flex justify-content-center align-items-center fw-medium text-white gap-2">
                ...
                <input type="range" class="mx-auto w-100 form-range" id="duration-slider" value="0">
