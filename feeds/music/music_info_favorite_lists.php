    ...
    <div class="d-flex justify-content-between align-items-center rounded-4 bg-dark-subtle bg-opacity-10 my-2">
      <a class="hide-scrollbar link-body-emphasis text-decoration-none music text-start w-100 text-white btn fw-bold border-0" href="play_favorite.php?mode=<?php echo isset($_GET['mode']) ? $_GET['mode'] : 'grid'; ?>&by=newest_lists&album=<?php echo urlencode($row['album']); ?>&id=<?php echo $row['id']; ?>" style="overflow-x: auto; white-space: nowrap;">
