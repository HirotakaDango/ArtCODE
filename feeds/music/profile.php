...
<html lang="en" data-bs-theme="dark">
  ...
  <body>
    ...
    <?php
      ...
      $by = isset($_GET['by']) ? ($_GET['by'] === 'grid' ? (isset($_GET['by']) && ($_GET['by'] === 'oldest' || $_GET['by'] === 'newest') ? $_GET['by'] : 'newest') : (isset($_GET['by']) && ($_GET['by'] === 'oldest_lists' || $_GET['by'] === 'newest_lists') ? $_GET['by'] : 'newest_lists')) : 'newest_lists';
      $url = "http://$domain/feeds/music/artist.php?mode=$mode&by=$by&id=$user_id_url";
    ?>
