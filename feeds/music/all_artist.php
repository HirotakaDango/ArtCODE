...
<html lang="en" data-bs-theme="dark">
  ...
  <body>
    ...
    <div class="container-fluid d-flex">
      ...
      <div class="dropdown mt-3 me-auto <?php echo ((isset($_GET['by']) && ($_GET['by'] === 'desc_lists' || $_GET['by'] === 'asc_lists')) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_desc_lists.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_asc_lists.php') !== false)) ? 'd-none' : ''; ?>">
      ...
      <div class="dropdown mt-3 me-auto <?php echo ((isset($_GET['by']) && ($_GET['by'] === 'desc' || $_GET['by'] === 'asc')) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_desc_grid.php') !== false) || (strpos($_SERVER['REQUEST_URI'], 'all_artist_asc_grid.php') !== false)) ? 'd-none' : ''; ?>">
        <button class="btn btn-sm fw-bold rounded-pill mb-2 btn-outline-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
          <i class="bi bi-images"></i> sort by
        </button>
        <ul class="dropdown-menu">
