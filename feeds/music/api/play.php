          ...
          <div class="bg-transparent rounded-5 w-100" style="max-width: 325px;">
            <div class="position-relative text-shadow p-2 p-md-0">
              ...
              <div class="btn-group w-100 align-items-center">
                ...
                <a class="btn border-0 link-body-emphasis w-25 text-white text-shadow" href="play.php?album=<?php echo urlencode(($prevIndex == 0) && ($selectedSongIndex == 0) ? $data[count($data) - 1]['album'] : $prevRow['album']); ?>&id=<?php echo ($prevIndex == 0) && ($selectedSongIndex == 0) ? $data[count($data) - 1]['id'] : $prevRow['id']; ?>">
                ...
                <a class="btn border-0 link-body-emphasis w-25 text-white text-shadow" href="play.php?album=<?php echo urlencode(($nextIndex == count($data)-1) && ($selectedSongIndex == count($data)-1) ? $data[0]['album'] : $nextRow['album']); ?>&id=<?php echo ($nextIndex == count($data)-1) && ($selectedSongIndex == count($data)-1) ? $data[0]['id'] : $nextRow['id']; ?>">
