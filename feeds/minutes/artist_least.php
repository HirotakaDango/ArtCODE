...
$queryvideos = "SELECT videos.*, users.id AS userid, users.pic, users.artist FROM videos JOIN users ON videos.email = users.email WHERE users.id = :userID ORDER BY videos.view_count ASC LIMIT :limit OFFSET :offset";
    ...
    <div class="container mt-3">
      <div class="pagination d-flex gap-1 justify-content-center mt-3">
        <?php if ($page > 1): ?>
          ...
          <a class="btn btn-sm btn-primary fw-bold" href="?by=least&id=<?php echo $userID; ?>&page=<?php echo $prevPage; ?>"><i class="bi text-stroke bi-chevron-left"></i></a>
        <?php endif; ?>
        ...
        <?php if ($page < $totalPages): ?>
          <a class="btn btn-sm btn-primary fw-bold" href="?by=least&id=<?php echo $userID; ?>&page=<?php echo $nextPage; ?>"><i class="bi text-stroke bi-chevron-right"></i></a>
