...
if (isset($_GET['delete_reply_id'])) {
  ...
  if ($reply_info_result !== false) {
    ...
    $redirect_url = 'reply_comment_minute.php?sort=' . urlencode($replySort) . '&by=' . urlencode($sortUrl) . '&minuteid=' . urlencode($minuteid) . '&comment_id=' . urlencode($comment_id) . '&page=' . urlencode($pageUrl);
