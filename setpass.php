...
if (isset($_POST['submit'])) {
  ...
  $current_password = substr(filter_var($_POST['current_password'], FILTER_SANITIZE_STRING), 0, 40);
  $new_password = substr(filter_var($_POST['new_password'], FILTER_SANITIZE_STRING), 0, 40);
  $confirm_password = substr(filter_var($_POST['confirm_password'], FILTER_SANITIZE_STRING), 0, 40);
