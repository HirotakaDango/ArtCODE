      ...
      <div class="container fw-bold text-secondary mt-4">
        ...
        <form method="POST">
          <div class="mb-3">
            ...
            <input type="password" class="form-control rounded-3 border text-secondary fw-bold border-4" name="current_password" maxlength="40" pattern="^[a-zA-Z0-9_@.-]+$">
          </div>
          <div class="mb-3">
            <label class="form-label">New Password:</label>
            <input type="password" class="form-control rounded-3 border text-secondary fw-bold border-4" name="new_password" maxlength="40" pattern="^[a-zA-Z0-9_@.-]+$">
          </div>
          <div class="mb-3">
            <label class="form-label">Confirm Password:</label>
            <input type="password" class="form-control rounded-3 border text-secondary fw-bold border-4" name="confirm_password" maxlength="40" pattern="^[a-zA-Z0-9_@.-]+$">
          </div>
