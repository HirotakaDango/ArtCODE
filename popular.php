...
if (isset($_POST['favorite'])) {
  ...
  $existing_fav = $dbP->querySingle("SELECT COUNT(*) FROM favorites WHERE username = '{$_SESSION['username']}' AND image_id = $image_id");

  if ($existing_fav == 0) {
    $dbP->exec("INSERT INTO favorites (username, image_id) VALUES ('{$_SESSION['username']}', $image_id)");
  }
  ...
  $image_id = $_POST['image_id'];
  $dbP->exec("DELETE FROM favorites WHERE username = '{$_SESSION['username']}' AND image_id = $image_id");
      ...
      ?>
        <div class="image-container">
          ...
          <div class="favorite-btn">
            <?php
              $stmt = $dbP->prepare("SELECT COUNT(*) FROM favorites WHERE username = ? AND image_id = ?");
