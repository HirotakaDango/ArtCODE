                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content rounded-3 shadow">
                      <div class="modal-header border-0">
                        <h5 class="modal-title fw-bold"><?php echo $imageP['title']?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body p-4 text-center">
                        <img class="rounded object-fit-cover mb-3 shadow lazy-load" data-src="thumbnails/<?php echo $imageP['filename']; ?>" style="width: 100%; height: 100%;">
                        <p class="text-start fw-semibold"><?php echo $imageP['imgdesc']?></p>
                        <div class="card container">
                          <p class="text-center fw-semibold mt-2">Image IPnformation</p>
