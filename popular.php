  ...
  <body>
    ...
    <div class="images mb-2">
      <?php
        ...
        $stmtP = $dbP->prepare("SELECT images.id, images.filename, images.tags, images.imgdesc, images.title, images.type, COUNT(favorites.id) AS favorite_count FROM images LEFT JOIN favorites ON images.id = favorites.image_id GROUP BY images.id ORDER BY favorite_count DESC LIMIT :limit OFFSET :offset");
