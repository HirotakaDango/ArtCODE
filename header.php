        ...
        <div class="dropdown nav-right">
          ...
          <ul class="dropdown-menu dropdown-menu-end" style="width: 300px;">
            <div class="text-center mb-2">
              <a class="d-block" href="propic.php"><img class="rounded-circle object-fit-cover border border-5" width="150" height="150" src="<?php echo !empty($pic1) ? $pic1 : "icon/profile.svg"; ?>" alt="Profile Picture"></a>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-bold d-none-sm">
              <form action="search.php" method="GET" class="mb-3">
                <div class="input-group">
                  <input type="text" name="search" class="form-control fw-bold" placeholder="Search by tags or title" required>
