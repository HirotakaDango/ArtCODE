...
$stmt = $db->prepare("CREATE TABLE IF NOT EXISTS comments (id INTEGER PRIMARY KEY, filename TEXT, username TEXT, comment TEXT, created_at TEXT)");
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
  ...
  $stmt = $db->prepare("INSERT INTO comments (filename, username, comment, created_at) VALUES (:filename, :username, :comment, :created_at)");
  $stmt->bindValue(':filename', $filename, SQLITE3_TEXT);
...
<html>
  ...
  <body>
    ...
    <br><br>    <nav class="navbar fixed-top navbar-expand-md navbar-light bg-white shadow-sm shadow-md shadow-lg">
      <div class="container-fluid">
        <button class="navbar-toggler1 d-md-none" type="button" onclick="goBack()">
          <img src="icon/back.svg" width="22" height="22">
        </button> 
