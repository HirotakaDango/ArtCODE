...
?>
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item fw-bold <?php echo isset($_GET['by']) && $_GET['by'] != 'oldest' ? 'active' : ''; ?>" href="?by=newest&page=<?php echo isset($_GET['page']) ? $_GET['page'] : '1'; ?>">Newest</a></li>
        <li><a class="dropdown-item fw-bold <?php echo isset($_GET['by']) && $_GET['by'] == 'oldest' ? 'active' : ''; ?>" href="?by=oldest&page=<?php echo isset($_GET['page']) ? $_GET['page'] : '1'; ?>">Oldest</a></li>
      </ul>
    </div> 
