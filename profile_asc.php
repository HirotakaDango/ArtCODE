                    ...
                    <div class="modal-body p-4 text-center">
                      ...
                      <div class="row featurette">
                        ...
                        <div class="col-md-7 order-md-2">
                          ...
                          <a class="btn btn-primary fw-bold rounded-4 w-100" href="download_images.php?artworkid=<?php echo $imageA['id']; ?>" download><i class="bi bi-download"></i> download image</a>
