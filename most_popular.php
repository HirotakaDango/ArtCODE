...
$stmtP = $dbP->prepare("SELECT images.id, images.filename, images.tags, images.title, images.imgdesc, COUNT(favorites.id) AS favorite_count FROM images LEFT JOIN favorites ON images.id = favorites.image_id GROUP BY images.id ORDER BY favorite_count DESC LIMIT 50");
                        ...
                        <div class="row featurette">
                          ...
                          <div class="col-md-7 order-md-2">
                            ...
                            <div class="btn-group w-100 mt-2 mb-3">
                              ...
                              <button class="btn btn-outline-dark fw-bold" onclick="shareImageP(<?php echo $imageP['id']; ?>)"><i class="bi bi-share-fill text-stroke"></i> share</button>
                            </div>
