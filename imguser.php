    ...
    <div id="image-carousel" class="carousel slide carousel-fade mt-2" style="margin-bottom: 3px;" data-bs-ride="false">
      <div class="carousel-inner">
        <?php foreach ($images as $index => $imageU): ?>
          ...
          ?>
          <div class="carousel-item <?php echo $active_class; ?><?php echo ($index === 0) ? ' active' : ''; ?>">
