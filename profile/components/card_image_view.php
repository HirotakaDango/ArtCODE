                            ...
                            <div id="div2_<?php echo $imageV['id']; ?>" class="overflow-auto col-md-5 h-100 scrollable-div">
                              <div class="p-3">
                                ...
                                <div class="collapse mt-2" id="collapseInfoDesktop">
                                  <div class="card rounded-4 container">
                                    ...
                                    <?php
                                      ...
                                      $imageV_folder_path = $_SERVER['DOCUMENT_ROOT'] . '/images/';
    
                                      // Calculate and display image size and dimensions for the main image
                                      $imageV_path = $imageV_folder_path . $imageV['filename'];
                                      $imageV_size = round(filesize($imageV_path) / (1024 * 1024), 2);
                                      $total_image_size += $imageV_size;
                                      list($width, $height) = getimagesize($imageV_path);
                                      ...
                                      echo "<div class='mb-3 row'>
                                              ...
                                              <div class='col-sm-8'>
                                                <input type='text' class='form-control-plaintext fw-bold' id='' value='{$imageV_size} MB' readonly>
                                              </div>
                                            </div>";
                                      ...
                                      while ($child_image = $child_images_result->fetchArray()) {
                                        $child_image_path = $imageV_folder_path . $child_image['filename'];
                                ...
                                <div class="collapse mt-2" id="collapseDownload">
                                  <a class="btn btn-primary fw-bold rounded-4 w-100" href="#" onclick="downloadWithProgressBar(<?php echo $imageV['id']; ?>, '<?php echo $imageV['title']; ?>')">
                                    <i class="bi bi-download text-stroke"></i> download all images (<?php echo $total_image_size; ?> MB)
                                  </a>
                                  <div class="progress fw-bold mt-2 rounded-4" id="progressBarContainer_<?php echo $imageV['id']; ?>" style="height: 30px; display: none;">
                                    <div id="progressBar_<?php echo $imageV['id']; ?>" class="progress-bar progress-bar progress-bar-animated fw-bold" style="width: 0; height: 30px;">0%</div>
                                  </div>
                                  <script>
                                  ...
                                  <p class="fw-bold text-center container">
                                    <small>2. If you found download error or failed, <a class="text-decoration-none" href="/download_images.php?artworkid=<?php echo $imageV['id']; ?>">click this link</a> for third option if download all images error or failed.</small>
                                  </p>
                                  <p class="fw-bold text-center container">
