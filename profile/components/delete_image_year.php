...
?>
            ...
            <div>
              <form action="../../profile/delete.php?by=<?php echo isset($_GET['by']) ? $_GET['by'] : 'newest'; ?>&page=<?php echo $page; ?>" method="post">
                <!-- Modal -->
                <div class="modal fade" id="deleteImage_<?php echo $imageY['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <div class="modal-body d-flex justify-content-center align-items-center">
                        <div class="card container rounded-5 p-3 position-relative" style="max-width: 750px;">
                          ...
                          <div class="row d-flex justify-content-center">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              <div class="card border-0 rounded-4 overflow-auto scrollable-div" style="max-height: 250px;">
                                <a class="w-100 h-100" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/image.php?artworkid=<?php echo $imageY['id']; ?>">
                                  <div class="ratio ratio-1x1">
                                    <img class="rounded-4 object-fit-cover shadow lazy-load" data-src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $imageY['filename']; ?>" alt="<?php echo $imageY['title']; ?>">
                                  </div>
                                </a>
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="h-100">
                                <div class="card-body">
                                  <h5 class="text-center fw-bold"><?php echo $imageY['title']?></h5>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="btn-group w-100">
                            <input type="hidden" name="id" value="<?php echo $imageY['id']; ?>">
