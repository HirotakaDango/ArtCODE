            ...
            <div class="position-relative">
              ...
              <?php include('../rows_columns/image_counts.php'); ?>
                <div class="dropdown">
                  ...
                  <?php include('share_profile_daily.php'); ?>
                </div>
              </div>
            </div>

            <?php include($_SERVER['DOCUMENT_ROOT'] . '/profile/components/delete_image_daily.php'); ?>
            <?php include($_SERVER['DOCUMENT_ROOT'] . '/profile/components/card_image_daily.php'); ?>
