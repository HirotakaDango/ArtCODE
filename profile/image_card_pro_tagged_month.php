    <div class="w-100 px-1">
      <div class="<?php include('../rows_columns/row-cols.php'); echo $rows_columns; ?>">
        <?php foreach ($results as $imageM): ?>
          <div class="col">
            <div class="position-relative">
              <a class="rounded ratio ratio-1x1" href="../image.php?artworkid=<?php echo $imageM['id']; ?>">
                <img class="rounded rounded-bottom-0 shadow object-fit-cover lazy-load <?php echo ($imageM['type'] === 'nsfw') ? 'nsfw' : ''; ?>" data-src="../thumbnails/<?php echo $imageM['filename']; ?>" alt="<?php echo $imageM['title']; ?>">
              </a> 
              <?php
              ...
              <?php include('../rows_columns/image_counts.php'); ?>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><button class="dropdown-item fw-bold" onclick="location.href='../edit_image.php?id=<?php echo $imageM['id']; ?>'" ><i class="bi bi-pencil-fill"></i> edit image</button></li>
                    <li><button class="dropdown-item fw-bold" data-bs-toggle="modal" data-bs-target="#deleteImage_<?php echo $imageM['id']; ?>"><i class="bi bi-trash-fill"></i> delete</button></li>
                    <?php
                    ...
                    $stmt->bindValue(':image_id', $imageM['id']);
                    $stmt->execute();
                  ...
                  <?php include('share_profile_month.php'); ?>
                </div>
              </div>
            </div>

            <?php include($_SERVER['DOCUMENT_ROOT'] . '/profile/components/delete_image_month.php'); ?>
            <?php include($_SERVER['DOCUMENT_ROOT'] . '/profile/components/card_image_month.php'); ?>
