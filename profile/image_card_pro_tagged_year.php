              ...
              <div class="position-absolute top-0 start-0">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><button class="dropdown-item fw-bold" onclick="location.href='../edit_image.php?id=<?php echo $imageY['id']; ?>'" ><i class="bi bi-pencil-fill"></i> edit image</button></li>
                    <li><button class="dropdown-item fw-bold" data-bs-toggle="modal" data-bs-target="#deleteImage_<?php echo $imageY['id']; ?>"><i class="bi bi-trash-fill"></i> delete</button></li>
                    <?php
                    ...
                    $stmt->bindValue(':image_id', $imageY['id']);
                    $stmt->execute();
                  ...
                  <?php include('share_profile_year.php'); ?>
                </div>
              </div>
            </div>

            <?php include($_SERVER['DOCUMENT_ROOT'] . '/profile/components/delete_image_year.php'); ?>
            <?php include($_SERVER['DOCUMENT_ROOT'] . '/profile/components/card_image_year.php'); ?>
