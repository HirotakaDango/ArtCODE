    ...
    <div class="container-fluid w-100">
      <div class="row g-0">
        <div class="col-md-3 d-none d-md-block overflow-auto border-0" style="height: calc(100svh - 52px); max-height: calc(100svh - 52px); min-height: calc(100svh - 52px); box-sizing: border-box;">
          <iframe src="/text/side_view.php?uid=<?php echo $_GET['uid']; ?>" class="overflow-auto w-100" style="height: calc(100svh - 60px); max-height: calc(100svh - 60px); min-height: calc(100svh - 60px); box-sizing: border-box;"></iframe>
        </div>
          ...
          <div class="container mt-2">
            ...
            if (!empty($result['tags'])) {
              ...
              foreach ($tags as $tag) {
                ...
                if (!empty($tag)) {
                  ?>
                  <a href="/text/?tag=<?php echo urlencode($tag); ?>" style="margin-bottom: 0.2em; margin-top: 0.2em;" class="btn btn-sm fw-medium btn-<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/opposite.php'); ?> rounded-pill">
                    <?php echo $tag; ?>
                  </a>
                  <?php
                }
            ...
            <div class="d-flex justify-content-between mt-4">
              <?php if ($is_favorited): ?>
                <form method="POST">
                  ...
                  <button type="submit" class="btn border-0 p-0" name="unfavorite">
              ...
              <?php else: ?>
                <form method="POST">
                  <input type="hidden" name="text_id" value="<?php echo $result['id']; ?>">
                  <button type="submit" class="btn border-0 p-0" name="favorite">
