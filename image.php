        ...
        <div class="cool-6">
          <div class="caard">
            <div class="me-2 ms-2 rounded img-thumbnail fw-bold">
              <p class="text-secondary fw-bold text-center"><?php echo $image['title']; //echo "SELECT * FROM images WHERE filename = $filename"; ?></p>
              ...
              <?php if ($next_image): ?>
                <button class="btn btn-sm btn-primary fw-bold float-start rounded-pill mt-1" onclick="location.href='image.php?filename=<?= $next_image['id'] ?>'">
                  <i class="bi bi-arrow-left-circle-fill"></i> Next
                </button>
              <?php endif; ?> 
              <?php if ($prev_image): ?>
                <button class="btn btn-sm btn-primary fw-bold float-end rounded-pill mt-1" onclick="location.href='image.php?filename=<?= $prev_image['id'] ?>'">
