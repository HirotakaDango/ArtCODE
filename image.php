            ...
            <div class="favorite-btn">
              ...
              ?>
                <form action="image.php?filename=<?php echo $image['filename']; ?>" method="POST">
                  ...
                  <button style="margin-top: -70px;" type="submit" class="btn p-b3 btn-sm btn-dark opacity-75 rounded fw-bold" name="unfavorite"><i class="bi bi-heart-fill"></i> <?php echo $fav_count; ?></button>
                </form>
              <?php } else { ?>
                <form action="image.php?filename=<?php echo $image['filename']; ?>" method="POST">
                  <input type="hidden" name="image_id" value="<?php echo $image['id']; ?>">
                  <button style="margin-top: -70px;" type="submit" class="btn p-b3 btn-sm btn-dark opacity-75 rounded fw-bold" name="favorite"><i class="bi bi-heart"></i> <?php echo $fav_count; ?></button>
                </form>
              <?php } ?> 
            </div> 
          </div>
