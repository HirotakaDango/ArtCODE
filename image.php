                ...
                <?php if ($next_image): ?>
                  <a class="image-containerA shadow rounded" href="image.php?artworkid=<?= $next_image['id'] ?>">
                    <div class="position-relative">
                      ...
                      <h5 class="shadowed-text text-white position-absolute top-50 start-50 translate-middle">Next</h5>
                    </div>
                  </a>
                <?php endif; ?>
                ...
                <?php if ($prev_image): ?>
                  <a class="image-containerA shadow rounded" href="image.php?artworkid=<?= $prev_image['id'] ?>">
                    <div class="position-relative">
                      ...
                      <h5 class="shadowed-text text-white position-absolute top-50 start-50 translate-middle">Prev</h5>
                    </div>
                  </a>
                <?php endif; ?>
              </div>
