        ...
        <div class="cool-6">
          <div class="caard position-relative">
            ...
            <div class="position-absolute top-0 end-0 me-2 mt-2">
              <div class="btn-group">
                <div class="dropdown">
                  <button class="btn btn-sm btn-dark fw-bold opacity-75 rounded-3 text-white" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <p class="fw-bold text-center container"><small>(if you found download error, <a class="text-decoration-none" href="download_images.php?artworkid=<?= $image_id; ?>">click this link</a> for third option if download all images error)</small></p>
                    </div>
