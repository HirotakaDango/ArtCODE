...
<html lang="en">
  ...
  <body>
        ...
        <div class="cool-6">
          <div class="caard">
            <div class="me-2 ms-2 rounded img-thumbnail fw-bold">
              ...
              <p class="text-secondary font-sm fw-bold" style="word-break: break-word ;">
              <?php
                if (!empty($image['imgdesc'])) {
                  $replacedDesc = preg_replace('/\b(https?:\/\/\S+)/i', '<a class="text-decoration-none" target="_blank" href="$1">$1</a>', $image['imgdesc']);
                    echo $replacedDesc;
                }
              ?>
              </p>
              ...
              <div class="btn-group w-100 " role="group" aria-label="Basic example">
                <button class="btn btn-secondary opacity-50 fw-bold rounded-start-pill" onclick="sharePage()"><i class="bi bi-share-fill"></i> <small>share</small></button>
                ...
                <button class="btn btn-primary dropdown-toggle fw-bold rounded-end-pill" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-info-circle-fill"></i> <small>information</small></button>
              ...
              <a class="btn btn-sm btn-primary rounded-pill fw-bold mt-2" href="comment.php?imageid=<?php echo $image['id']; ?>"><i class="bi bi-chat-left-text-fill"></i> <small>view comments</small></a>
    ...
    <?php
      include 'latest.php';
    ?>
    <p class="text-secondary fw-bold ms-2">Popular Images</p>
    <?php
