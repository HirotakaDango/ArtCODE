          ...
          <div class="caard position-relative">
            ...
            <div class="position-absolute top-0 end-0 me-2 mt-2">
              <div class="btn-group">
                ...
                <?php endif; ?>
                <div class="dropdown">
                  <button class="btn btn-sm btn-dark fw-bold opacity-75 rounded-3 rounded-start-0 text-white" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <div class="tag-buttons">
                <?php
                  ...
                  foreach ($tags as $tag) {
                    ...
                    if (!empty($tag)) {
                ?>
                  <a href="tagged_images.php?tag=<?php echo urlencode($tag); ?>" class="btn btn-sm btn-secondary mb-1 rounded-3 fw-bold opacity-50">
