              ...
              <div class="modal-dialog modal-dialog-centered modal-fullscreen modal-dialog-scrollable"> <!-- Add the modal-dialog-scrollable class -->
                <div class="modal-content border-0 bg-dark">
                  <div class="modal-body d-flex align-items-center justify-content-center p-0">
                    <div class="position-relative h-100 w-100 d-grid align-items-center">
                      ...
                      <div class="container mt-3 mb-5 fw-bold">
                        ...
                        <h5 class="text-white shadowed-text"><?php echo $image['title']; ?></h5>
