...
<html lang="en">
  ...
  <body>
      ...
      <div class="roow">
        <div class="cool-6">
          <div class="caard position-relative">
            <a href="images/<?php echo $image['filename']; ?>" id="originalImageLink">
              <img class="img-fluid rounded-r" src="thumbnails/<?= $image['filename'] ?>" alt="<?php echo $image['title']; ?>" width="100%" height="auto" data-original-src="images/<?php echo $image['filename']; ?>">
            </a>
    ...
    <script>
      ...
      const originalImageLink = document.getElementById("originalImageLink");
      const thumbnailImage = originalImageLink.querySelector("img");

      loadOriginalBtn.addEventListener("click", function(event) {
        event.preventDefault();
        const originalSrc = thumbnailImage.getAttribute("data-original-src");
