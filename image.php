        ...
        <div class="cool-6">
          <div class="caard position-relative">
                  ...
                  <div class="modal-body d-flex align-items-center justify-content-center p-0">
                    <div class="position-relative h-100 w-100 align-items-center">
                      <div class="position-relative">
                        <img id="originalImage" class="img-fluid" src="" alt="Original Image" style="width: 100%; height: auto;">
                        <div class="card-img-overlay m-3">
                          <h6 class="card-title text-white fw-bold shadowed-text"><?php echo $image['title']; ?> by           
                      ...
                      <div class="roow mb-5">
                        <div class="cool-6 d-flex justify-content-center">
                          <?php
                          ...
                          ?>
                          <div id="image-carouselF" class="carousel slide carousel-fade mt-2" style="margin-bottom: 3px; width: 98%;">
                            ...
                            <button class="carousel-control-prev" type="button" data-bs-target="#image-carouselF" data-bs-slide="prev">
                              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                              <span class="visually-hidden">Previous</span>
                            </button>
                            <button class="carousel-control-next" type="button" data-bs-target="#image-carouselF" data-bs-slide="next">
                            ...
                            <div class="btn-group mb-3 w-100">
                              ...
                              ?>
                                <form action="image.php?artworkid=<?php echo $image['id']; ?>" method="POST">
                                  ...
                                  <button type="submit" class="btn btn-sm btn-outline-light opacity-75 rounded-3 rounded-end-0 fw-bold" name="unfavorite"><i class="bi bi-heart-fill"></i> <small>unfavorite</small></button>
                                </form>
                              <?php } else { ?>
                                <form action="image.php?artworkid=<?php echo $image['id']; ?>" method="POST">
                                  <input type="hidden" name="image_id" value="<?php echo $image['id']; ?>">
                                  <button type="submit" class="btn btn-sm btn-outline-light opacity-75 rounded-3 rounded-end-0 fw-bold" name="favorite"><i class="bi bi-heart"></i> <small>favorite</small></button>
                                </form>
                              <?php } ?>
                              <button class="btn btn-sm btn-outline-light opacity-75 rounded-0 rounded-start-0 fw-bold" onclick="sharePage()"><i class="bi bi-share-fill"></i> <small>share</small></button>
                              <a class="btn btn-sm btn-outline-light opacity-75 rounded-0 rounded-end-0 fw-bold" href="images/<?php echo $image['filename']; ?>"><i class="bi bi-eye-fill"></i> <small>full res</small></a>
                              <a class="btn btn-sm btn-outline-light fw-bold opacity-75 rounded-3 rounded-start-0 text-white" href="images/<?php echo $image['filename']; ?>" download>
            ...
            <div class="position-absolute bottom-0 end-0 me-2 mb-2">
              <div class="btn-group">
                <a class="btn btn-sm btn-dark opacity-75 rounded-3 rounded-end-0" href="images/<?php echo $image['filename']; ?>"><i class="bi bi-eye-fill"></i></a>
                <button class="btn btn-sm btn-dark fw-bold opacity-75 rounded-0 text-white" id="loadOriginalBtn">Load Original Image</button>
                <a class="btn btn-sm btn-dark fw-bold opacity-75 rounded-3 rounded-start-0 text-white" href="images/<?php echo $image['filename']; ?>" download>
              ...
              <div class="btn-group w-100" role="group" aria-label="Basic example">
                ...
                <ul class="dropdown-menu dropdown-menu-end bg-light border-0 shadow-sm p-0">
                  <?php
                    ...
                    // Get MIME type
                    $mime_type = mime_content_type('images/' . $image['filename']);

                    // Get the image date
                    $date = date('Y/F/l jS', strtotime($image['date']));
                  ...
                  <div class="card border-0 m-0">
                    <div class="card-body p-3">
                      <ul class="list-unstyled m-0">
                        <li class="mb-2"><i class="bi bi-file-earmark"></i> Filename: <?php echo $filename; ?></li>
                        <li class="mb-2"><i class="bi bi-file-earmark-bar-graph"></i> image data size: <?php echo $image_size; ?> MB</li>
                        <li class="mb-2"><i class="bi bi-arrows-angle-expand text-stroke"></i> image dimensions: <?php echo $width; ?>x<?php echo $height; ?></li>
                        <li class="mb-2"><i class="bi bi-file-earmark-text"></i> MIME type: <?php echo $mime_type; ?></li>
                        <li class="mb-2"><i class="bi bi-calendar"></i> Image date: <?php echo $date; ?></li>
                        <li>
