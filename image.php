          ...
          <div class="caard">
            <div class="me-2 ms-2 rounded img-thumbnail fw-bold">
              ...
              <div class="mt-3">
                ...
                <a class="btn btn-sm btn-primary rounded-pill fw-bold me-1 mt-2" href="comment.php?imageid=<?php echo $image['id']; ?>"><i class="bi bi-chat-left-text-fill"></i> view comments</a>
              </div>
