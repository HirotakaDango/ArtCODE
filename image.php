        ...
        <div class="cool-6">
          <div class="caard position-relative">
            ...
            <div class="position-absolute bottom-0 end-0 me-2 mb-2">
              ...
              <div class="modal fade" id="downloadOption" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <?php endif; ?>
                      <div class="progress" class="progress fw-bold" style="height: 30px; display: none;">
                      ...
                      <p class="fw-bold text-center container"><small>Download can take a long time, wait until progress bar reach 100% or pop up download notification.</small></p>
                    </div>
              ...
              <div class="modal fade" id="rusModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
          ...
          <div class="d-none d-md-block d-lg-block">
            <div class="rounded-4 alert alert-warning fw-bold"><small><p>first original image have been compressed to <?php echo round($reduction_percentage, 2); ?>%</p> (<a class="text-decoration-none" href="images/<?php echo $image['filename']; ?>">view original to open original image</a>)</small></div>
          </div>
        </div>
        <div class="cool-6">
          <div class="container d-md-none d-lg-none">
            <div class="alert alert-warning fw-bold">
              <small>first original image have been compressed to <?php echo round($reduction_percentage, 2); ?>% (<a class="text-decoration-none" href="images/<?php echo $image['filename']; ?>">view original to open original image</a>)</small>
            </div>
          </div>
