      ...
      <div class="roow">
        <div class="cool-6">
          <div class="bg-body-tertiary d-flex justify-content-center d-md-none d-lg-none">
            <?php if ($next_image): ?>
              <button class="btn me-auto border-0" onclick="location.href='?artworkid=<?= $next_image['id'] ?>'">
                <i class="bi bi-chevron-left text-stroke"></i>
              </button>
            <?php endif; ?> 
            <h6 class="position-absolute start-50 fw-bold translate-middle-x mt-2 overflow-x-auto text-nowrap mx-auto"><?php echo $image['title']; ?></h6>
            <?php if ($prev_image): ?>
              <button class="btn ms-auto border-0" onclick="location.href='?artworkid=<?= $prev_image['id'] ?>'">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><small><a class="dropdown-item fw-bold" href="#">Total Images: <?php echo $total_all_images; ?> images</a></small></li>
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a class="dropdown-item fw-bold" href="view/gallery/?artworkid=<?php echo $image['id']; ?>">
                        <i class="bi bi-arrows-fullscreen text-stroke"></i> full gallery view
                      </a>
                    </li>
                    <li>
            ...
            <div class="me-2 ms-2 rounded fw-bold">
              <div class="d-flex d-md-none d-lg-none gap-2">
                ...
                <?php else: ?>
                  <a class="image-containerA shadow rounded" href="artist.php?id=<?php echo $user['id']; ?>">
                    <div class="position-relative">
                      <img class="img-blur object-fit-cover rounded opacity-75" style="width: 100%; height: 120px;" src="<?php echo $user['pic']; ?>" alt="<?php echo $user['artist']; ?>">
                      <h6 class="fw-bold shadowed-text text-white position-absolute top-50 start-50 translate-middle">
              ...
              <div style="word-break: break-word;" data-lazyload>
                ...
                <?php
                  ...
                  ?>
                    ...
                    <small>
                      <a href='tagged_images.php?tag=<?php echo urlencode($tag); ?>' 
                        class='text-decoration-none mb-1 rounded-3 fw-bold opacity-50' 
                        style='font-size: 12px; letter-spacing: 0.4px; line-height: 1.8;'>
                        <?php echo $tag; ?>(<?php echo $tagCount; ?>)
                      </a>
                    </small>
                  <?php endforeach; 
                } ?>
              ...
              <div class="d-none d-md-flex d-lg-flex mt-2 gap-2">
                ...
                <?php else: ?>
                  <a class="image-containerA shadow rounded" href="artist.php?id=<?php echo $user['id']; ?>">
                    <div class="position-relative">
                      <img class="img-blur object-fit-cover rounded opacity-75" style="width: 100%; height: 160px;" src="<?php echo $user['pic']; ?>" alt="<?php echo $user['artist']; ?>">
                      <h6 class="fw-bold shadowed-text text-white position-absolute top-50 start-50 translate-middle">
                        <i class="bi bi-box-arrow-in-up-left text-stroke"></i> All
                      </h6>
                    </div> 
