                    ...
                    <div class="position-relative h-100 w-100 align-items-center">
                      ...
                      <div class="roow mb-5 mt-2">
                        <div class="cool-6 d-flex justify-content-center">
                          ...
                          ?>
                          <div id="image-carouselF" class="carousel container-fluid slide carousel-fade mt-2 w-100">
                        ...
                        <div class="cool-6">
                          <div class="container mt-3 fw-bold">
                            <div class="btn-group mb-3 w-100">
                              ...
                              <?php } ?>
                              <button class="btn btn-sm btn-outline-light rounded-0 rounded-start-0 fw-bold" onclick="sharePage()"><i class="bi bi-share-fill"></i> <small>share</small></button>
                              <a class="btn btn-sm btn-outline-light rounded-0 rounded-end-0 fw-bold" href="images/<?php echo $image['filename']; ?>"><i class="bi bi-eye-fill"></i> <small>full res</small></a>
                              <a class="btn btn-sm btn-outline-light fw-bold rounded-2 rounded-start-0" href="images/<?php echo $image['filename']; ?>" download>
