      ...
      <div class="roow">
        <div class="cool-6">
          <div class="caard position-relative">
            ...
            <div class="position-absolute bottom-0 start-0 ms-2 mb-2">
              <div class="btn-group">
                ...
                <button class="btn btn-sm btn-dark opacity-75 rounded-3 rounded-start-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCompression1" aria-expanded="false" aria-controls="collapseExample">
          ...
          <div class="d-none d-md-block d-lg-block">
            <div class="rounded-4 alert alert-warning fw-bold"><small><p>first original image have been compressed to <?php echo round($reduction_percentage, 2); ?>%</p> (<a class="text-decoration-none" href="images/<?php echo $image['filename']; ?>">click to view original image</a>)</small></div>
          </div>
        </div>
        <div class="cool-6">
