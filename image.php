        ...
        <div class="cool-6">
          <div class="caard position-relative">
                    ...
                    <div class="position-relative h-100 w-100 align-items-center">
                      ...
                      <?php foreach ($child_images as $child_image) : ?>
                        <div class="image-container position-relative">
                          <img data-src="images/<?php echo $child_image['filename']; ?>" class="mb-1 img-fluid lazy-load" alt="<?php echo $image['title']; ?>">
                          <a href="images/<?php echo $child_image['filename']; ?>" class="btn btn-sm btn-dark opacity-75 fw-bold position-absolute bottom-0 end-0 m-3" download>
                      ...
                      <div class="mt-2 mb-2 w-98 scroll-container media-scrollerF snaps-inlineF overflow-auto">
                        ...
                        <script>
                          ...
                          function loadMoreImagesF() {
                            for (var i = currentIndexF; i < currentIndexF + 15 && i < imagesF.length; i++) {
            ...
            <div class="position-absolute top-0 end-0 me-2 mt-2">
              <div class="btn-group">
                <button class="btn btn-sm btn-dark fw-bold opacity-75 rounded text-white"><i class="bi bi-images"> </i><?php echo $total_all_images; ?></button>
              </div>
            </div>
