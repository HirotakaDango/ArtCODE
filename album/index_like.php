...
$stmt = $db->prepare('
    SELECT images.*, album.album_name, image_album.id AS image_album_id
    FROM image_album
    ...
    WHERE image_album.album_id = :album_id AND image_album.email = :email AND favorites.email = :email
