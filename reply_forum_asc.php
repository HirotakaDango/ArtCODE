...
if ($comment_id !== null) {
  ...
  $replies = $db->prepare('SELECT rc.*, u.artist, u.pic, u.id as userid FROM reply_forum rc JOIN users u ON rc.email = u.email WHERE rc.comment_id = ? ORDER BY rc.id ASC');
                ...
                <div class="dropdown ms-auto position-relative">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <form action="" method="get">
                      <a href="edit_reply_forum.php?sort=<?php echo $replySort; ?>&by=<?php echo $sortUrl; ?>&reply_id=<?php echo $reply['id']; ?>&comment_id=<?php echo $commentId; ?>&page=<?php echo $pageUrl; ?>" class="dropdown-item fw-semibold">
