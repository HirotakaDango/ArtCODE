...
$stmt = $db->prepare("SELECT images.*, users.username FROM images INNER JOIN users ON images.username = users.username ORDER BY images.id ASC LIMIT :limit OFFSET :offset");
