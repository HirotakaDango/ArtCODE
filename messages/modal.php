...
<html lang="en" data-bs-theme="<?php include($_SERVER['DOCUMENT_ROOT'] . '/appearance/mode.php'); ?>">
  ...
  <body>
    <div class="fixed-top container-fluid bg-dark-subtle py-1">
      <div class="d-flex justify-content-between">
        <div class="dropdown ms-auto">
          <button class="btn border-0 fw-medium" id="toggleButton" onclick="toggleAutoScroll()">Auto-Scroll: ON</button>
        </div>
      </div>
    </div>
