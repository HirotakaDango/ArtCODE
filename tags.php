...
<html>
  ...
  <body>
        ...
        <div class="offcanvas offcanvas-start w-50" tabindex="-1" id="navbar" aria-labelledby="navbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-bold">
              ...
              <li class="nav-item">
                <a class="nav-link nav-center active" href="tags.php">
    ...
    <br><br>
    <h5 class="text-secondary ms-2 mt-2 fw-bold"><i class="bi bi-tags-fill"></i> <?php echo $totalTagCount; ?> Tags</h5>
      ...
      <?php foreach ($tags as $tag): ?>
        ...
        ?>
          <a href="tagged_images.php?tag=<?php echo urlencode($tag); ?>"
            class="tag-button">
            <?php echo $tag; ?> (<?php echo $countResult; ?>)
          </a>
        <?php endif; ?>
      <?php endforeach; ?>
    </div> 
