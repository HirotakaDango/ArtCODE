          ...
          <nav class="navbar fixed-bottom mb-3">
            <form class="form-control border-0 container" action="" method="POST">
              <div class="input-group mb-3">
                <input type="text" class="form-control fw-bold" name="comment" placeholder="Type a something..." aria-label="Type a message..." aria-describedby="basic-addon2">
                <button class="btn btn-primary fw-bold" type="button"><i class="bi bi-send-fill"></i></button>
              </div>
            </form>
          </nav>
        </div>
