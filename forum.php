...
$stmt = $db->prepare("SELECT forum.*, users.artist, users.id FROM forum JOIN users ON forum.email = users.email ORDER BY forum.id DESC LIMIT :items_per_page OFFSET :offset");
