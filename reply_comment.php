...
if (isset($_POST['reply_comment_id'], $_POST['reply'])) {
  ...
  if (!empty($reply)) {
    ...
    header('Location: reply_comment.php?imageid='.$imageid.'&comment_id=' . $_POST['reply_comment_id']);
    exit();
  } else {
...
if (isset($_GET['delete_reply_id'])) {
  ...
  if ($reply_info_result !== false) {
    ...
    $redirect_url = 'reply_comment.php?imageid=' . urlencode($imageid) . '&comment_id=' . urlencode($comment_id);
...
<html>
  ...
  <body>
                ...
                <div class="dropdown ms-auto position-relative">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <form action="" method="get">
                      <a href="edit_reply_comment.php?reply_id=<?php echo $reply['id']; ?>&imageid=<?php echo $imageid; ?>" class="dropdown-item fw-semibold">
    ...
    <script>
      function goBack() {
        window.location.href = "comments.php?imageid=<?php echo $imageid;; ?>";
