          ...
          <div class="col-md-8 d-flex justify-content-center align-items-center">
            <div>
              ...
              <?php if ($firstEpisode !== null): ?>
                <a class="btn border-0 bg-secondary bg-opacity-10 w-100 rounded-4 fw-bold p-4 link-body-emphasis fs-custom-2 mb-md-0 mb-2" href="../image.php?artworkid=<?php echo $firstEpisodeId; ?>">
                  Read first chapter
                </a>
              <?php endif; ?>
            </div>
