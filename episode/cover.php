      <div class="bg-body-tertiary rounded-4 p-md-5 p-3 w-100 mb-4 shadow position-relative">
        <div class="row g-5">
          ...
          <div class="col-md-8 d-flex justify-content-center align-items-center">
            <div>
              <h4 class="fw-bold text-start my-2"><?php echo $episodeName; ?></h4>
              ...
              <?php if ($firstEpisode !== null): ?>
                <a class="btn border-0 bg-secondary bg-opacity-10 w-100 rounded-4 fw-bold p-4 link-body-emphasis fs-4" href="../image.php?artworkid=<?php echo $firstEpisode; ?>">
                  Read first episode
                </a>
              <?php endif; ?>
            </div>
