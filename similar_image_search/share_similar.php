                    ...
                    <div class="modal-content bg-transparent border-0 rounded-0">
                      <div class="card rounded-4 p-4">
                        ...
                        <div class="input-group">
                          <input type="text" id="urlInput_<?php echo $image['id']; ?>" value="<?php echo $url; ?>" class="form-control border-2 fw-bold" readonly>
                          <button class="btn btn-secondary opacity-50 fw-bold" onclick="copyToClipboard_<?php echo $image['id']; ?>()">
