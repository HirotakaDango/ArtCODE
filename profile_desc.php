                ...
                <div class="modal-dialog modal-fullscreen" role="document">
                  <div class="modal-content shadow">
                    <div class="modal-body p-4 text-center">
                      ...
                      <p class="fw-semibold">"<?php echo $imageD['title']?>" will be deleted permanently!</p>
                      <div class="row featurette">
                        <div class="col-md-5 order-md-1 mb-2">
                          <div class="position-relative">
                            <img class="rounded object-fit-cover shadow lazy-load" data-src="thumbnails/<?php echo $imageD['filename']; ?>" style="width: 100%; height: 100%;">
                        ...
                        <div class="col-md-7 order-md-2">
                          <div class="card container">
                            ...
                            <?php
                              ...
                              $imageD_size = round(filesize('images/' . $imageD['filename']) / (1024 * 1024), 2);

                              // Get image dimensions
                              list($width, $height) = getimagesize('images/' . $imageD['filename']);

                              // Display image information
                              echo "<p class='text-start fw-semibold'>Image data size: " . $imageD_size . " MB</p>";
                          ...
                          <a class="btn btn-primary fw-bold rounded-4 w-100" href="download_images.php?artworkid=<?php echo $imageD['id']; ?>" download><i class="bi bi-download"></i> download image</a>
                  ...
                  <div class="row featurette">
                    ...
                    <div class="col-md-7 order-md-2">
                      ...
                      <div class="btn-group w-100 mt-2 mb-3">
                        ...
                        <a class="btn btn-outline-dark fw-bold" href="images/<?php echo $imageD['filename']; ?>" download><i class="bi bi-download text-stroke"></i> download</a>
