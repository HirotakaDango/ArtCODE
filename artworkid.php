...
// (Rest of your code remains the same, setting up previous/next images, following actions, etc.)
  ...
  <body>
    ...
    <script>
      function hideSpinner() {
        ...
        window.location.href = 'artworkid_load.php?artworkid=<?php echo $image["id"]; ?>';
      }
    </script>
  </body>
</html>