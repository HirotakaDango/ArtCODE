          ...
          <div class="card mb-2">
            <div class="ms-1">
              <p class="text-dark fw-bold mt-1">
                ...
                <a class="text-dark text-decoration-none" href="artist.php?id=<?php echo $reply['userid']; ?>" target="_blank">@<?php echo $reply['artist']; ?></a>
              </p>
              ...
              <?php if ($_SESSION['email'] === $reply['email']): ?>
                <form action="" method="get">
                  <div class="btn-group position-absolute top-0 end-0 mt-1 me-1 opacity-50">
                    <a href="edit_reply_comments_preview.php?reply_id=<?php echo $reply['id']; ?>&imageid=<?php echo $imageid; ?>" class="btn btn-sm btn-secondary"><i class="bi bi-pencil-fill"></i></a>
      ...
      <div class="fixed-bottom w-100">
        <form action="" method="POST">
          <div class="input-group w-100">
            ...
            <textarea id="message-input" name="reply" class="form-control rounded-top-0 rounded-bottom-1 rounded-end-0 fw-semibold border-start-0 border-bottom-0" style="height: 40px; max-height: 150px;" placeholder="Type your comment..." aria-label="Type a message..." aria-describedby="basic-addon2" 
