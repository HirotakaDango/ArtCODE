      ...
      <div class="fixed-bottom w-100">
        <form action="" method="POST">
          <div class="input-group w-100">
            ...
            <textarea id="message-input" name="reply" class="form-control rounded-top-0 rounded-end-0 fw-semibold" style="height: 40px; max-height: 150px;" placeholder="Type your comment..." aria-label="Type a message..." aria-describedby="basic-addon2" 
