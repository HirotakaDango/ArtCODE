<?php
  ...
  $stmt = $db->prepare("SELECT artist, pic, desc FROM users WHERE username = :username");
              ...
              <div class="card-body">
                <div class="row featurette container">
                  ...
                  <div class="col-md-7 order-md-2">
                    <h3 class="text-secondary ms-1 mt-2"><i class="bi bi-person-circle"></i> <?php echo $artist; ?> <i class="ms-2 bi bi-images"></i> <?php echo $count; ?> </h3>
