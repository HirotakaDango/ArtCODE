        ...
        <div class="image-container">
          ...
          <div>
            <form action="delete.php" method="post">
              ...
              <button class="p-b1 btn btn-sm btn-danger opacity-50 fw-bold" type="submit" onclick="return confirm('Are you sure?')" value="Delete"><i class="bi bi-trash-fill"></i>
            </form>
            <button class="p-b2 btn btn-sm btn-primary opacity-50 fw-bold" onclick="location.href='edit_image.php?id=<?php echo $image['id']; ?>'" ><i class="bi bi-pencil-fill"></i></button> 
          </div>
        </div>
      <?php endwhile; ?>
    </div>
