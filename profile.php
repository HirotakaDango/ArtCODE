                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content rounded-3 shadow">
                    <div class="modal-body p-4 text-center">
                      ...
                      <img class="rounded object-fit-cover mb-3 shadow" src="thumbnails/<?php echo $image['filename']; ?>" style="width: 100%; height: 300px; object-position: top;">
                      ...
                      <a class="btn btn-sm btn-primary fw-bold rounded-4" href="images/<?php echo $image['filename']; ?>" download><i class="bi bi-download"></i> download image</a>
                    </div>
