...
// Retrieve the count of images for each tag matching the search condition, sorted by count in descending order
$query = "SELECT tags, COUNT(*) as count FROM images";
if (!empty($searchCondition)) {
  $query .= " WHERE $searchCondition";
}
$query .= " GROUP BY tags ORDER BY COUNT(*) DESC";
...
arsort($currentTags); // Sort tags within the category by count in descending order
        ...
        <div class="row justify-content-center">
          <?php foreach ($groupedTags as $group => $tags): ?>
            <div class="col-4 col-md-2 col-sm-5 px-0">
              <a class="btn btn-outline-dark border-0 fw-medium d-flex flex-column align-items-center" href="tags.php?by=<?php echo $by; ?>&category=<?php echo $group; ?>">
