  <header>
    <div class="d-flex flex-column flex-md-row align-items-center text-secondary fw-bold pb-3 mb-4 container">
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        ...
        <a class="me-3 py-2 text-secondary text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#signin">Signin</a>
        <a class="me-3 py-2 text-secondary text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#signup">Signup</a>
