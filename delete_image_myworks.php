          <div>
            <form action="myworks_delete.php?by=<?php echo isset($_GET['by']) ? $_GET['by'] : 'newest'; ?>&page=<?php echo isset($_GET['page']) ? $_GET['page'] : '1'; ?>" method="post">
              <!-- Modal -->
                            ...
                            <div class="card border-0 rounded-4 overflow-auto scrollable-div" style="max-height: 250px;">
                              <a class="w-100 h-100" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/image.php?artworkid=<?php echo $image['id']; ?>">
                                <div class="ratio ratio-1x1">
                                  <img class="rounded-4 object-fit-cover shadow lazy-load" data-src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/thumbnails/<?php echo $image['filename']; ?>" alt="<?php echo $image['title']; ?>">
                                </div>
                              </a>
                            </div>
                          </div>
