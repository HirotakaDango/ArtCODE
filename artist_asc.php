...
$query = $db->prepare('SELECT images.id, images.tags, images.filename, images.title, images.imgdesc, images.type FROM images JOIN users ON images.email = users.email WHERE users.id = :id ORDER BY images.id ASC LIMIT :limit OFFSET :offset');
$query->bindParam(':id', $id);
                          ...
                          <div class="row d-flex justify-content-center">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              <div class="card border-0 rounded-4 overflow-auto scrollable-div" style="max-height: 250px;">
                                <a class="w-100 h-100" href="image.php?artworkid=<?php echo $imageA['id']; ?>">
                                  <img class="rounded-4 object-fit-cover shadow lazy-load" height="400" width="100%" data-src="thumbnails/<?php echo $imageA['filename']; ?>" alt="<?php echo $imageA['title']; ?>">
                                </a>
                              </div>
                            ...
                            <div class="collapse mt-2" id="collapseInfoDesktop">
                              <div class="card rounded-4 container">
                                ...
                                <?php
                                  ...
                                  $image_size = round(filesize('images/' . $imageA['filename']) / (1024 * 1024), 2);
