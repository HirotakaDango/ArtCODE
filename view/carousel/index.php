  ...
  <body>
    <div id="content">
      ...
      <?php else : ?>
              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../../images/<?php echo $image['filename']; ?>" class="d-block w-100" alt="<?php echo $image['title']; ?>">
                  </div>
                  <?php foreach ($child_images as $child_image) : ?>
                    <?php if (!empty($child_image['filename'])) : ?>
                      <div class="carousel-item">
                        <img src="../../images/<?php echo $child_image['filename']; ?>" class="d-block w-100" alt="<?php echo $image['title']; ?>">
                      </div>
                    <?php endif; ?>
                  <?php endforeach; ?>
                </div>
        ...
        <a class="carousel-control-prev position-absolute start-0" href="#carouselExample" role="button" data-bs-slide="prev">
          <i class="bi bi-chevron-left display-5 text-white" style="-webkit-text-stroke: 4px;"></i>
        </a>
        <a class="carousel-control-next position-absolute end-0" href="#carouselExample" role="button" data-bs-slide="next">
        ...
        <div id="scrollButton">
          ...
          <div class="btn-group position-fixed bottom-0 start-50 translate-middle-x mb-2" style="z-index: 5;">
