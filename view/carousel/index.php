  ...
  <body>
    <div id="content">
      ...
      <?php else : ?>
        ...
        <div id="scrollButton">
          <a class="btn btn-sm btn-primary position-fixed start-0 top-0 m-2" href="../gallery/?artworkid=<?php echo $image['id']; ?>"><i class="bi bi-fullscreen text-stroke"></i></a>
          <div class="btn-group position-fixed bottom-0 start-50 translate-middle-x mb-2">
