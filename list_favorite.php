...
$query = $db->prepare('SELECT images.filename, images.id, images.title FROM images JOIN favorites ON images.id = favorites.image_id WHERE favorites.email = :email ORDER BY favorites.id DESC');
