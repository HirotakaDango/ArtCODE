      ...
      <?php while ($image = $result->fetchArray()): ?>
        <div class="image-container">
          <div class="position-relative">
            <a class="shadow rounded imageA" href="image.php?artworkid=<?php echo $image['id']; ?>">
              <img class="imageI lazy-load" data-src="thumbnails/<?php echo $image['filename']; ?>" alt="<?php echo $image['title']; ?>">
            </a> 
                        ...
                        <div class="row featurette">
                          ...
                          <div class="col-md-7 order-md-2">
                            ...
                            <div class="btn-group w-100 mt-2 mb-3">
                              ...
                              <button class="btn btn-outline-dark fw-bold" onclick="shareImageL(<?php echo $image['id']; ?>)"><i class="bi bi-share-fill text-stroke"></i> share</button>
                            </div>
