      ...
      <div id="carouselExampleFade" class="carousel slide carousel-fade mb-2" data-bs-ride="carousel">
        <div class="carousel-inner">
          <?php
            ...
            $stmtP = $dbP->prepare("SELECT images.id, images.filename, images.tags, images.title, COUNT(favorites.id) AS favorite_count FROM images LEFT JOIN favorites ON images.id = favorites.image_id GROUP BY images.id ORDER BY favorite_count DESC LIMIT 42");
          ...
          ?>
            <a href="image.php?artworkid=<?php echo $image_id; ?>" class="grid-item item"> <!-- Add the "item" class here -->
              <img class="w-100 rounded shadow" src="thumbnails/<?php echo $filename; ?>" alt="<?php echo $title; ?>">
              ...
              ?>
                <div class="carousel-item <?php echo $count === 0 ? 'active' : ''; ?>">
                  <a href="image.php?artworkid=<?php echo $image_id; ?>">
                    <img class="d-block rounded w-100 h-custom" src="thumbnails/<?php echo $filename; ?>" alt="<?php echo $title; ?>">
                    <div class="carousel-caption">
                      <h5 class="fw-bold"><?php echo $title; ?></h5>
                    </div>
                  </a>
      ...
      <div class="media-scroller scrollable-div w-99 snaps-inline overflow-auto">
        ...
        ?>
          <div class="media-element d-inline-flex">
            <a class="hori" href="image.php?artworkid=<?php echo $image_id; ?>">
              <img class="hori" src="thumbnails/<?php echo $image_url; ?>" alt="<?php echo $imageP['title']; ?>">
            </a>
          </div>
        <?php endwhile; ?>
      </div>
