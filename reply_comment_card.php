                ...
                <div class="dropdown ms-auto position-relative">
                  ...
                  <div class="dropdown-menu dropdown-menu-end rounded-4 shadow border-0">
                    <form action="" method="get">
                      <a href="edit_reply_comment.php?sort=<?php echo $replySort; ?>&by=<?php echo $sortUrl; ?>&reply_id=<?php echo $reply['id']; ?>&comment_id=<?php echo $commentId; ?>&imageid=<?php echo $imageid; ?>&page=<?php echo $pageUrl; ?>" class="dropdown-item fw-medium">
