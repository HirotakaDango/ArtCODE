        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content bg-dark bg-opacity-25 shadow">
            <div class="modal-body">
              <a class="btn bg-dark bg-opacity-25 position-absolute top-0 start-0" style="border-radius: 0.5rem 0 0.5rem 0;" href="session.php"><i class="bi bi-chevron-left fs-4 text-stroke-2"></i></a>
