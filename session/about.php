  <div class="container">
    <div class="rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold animate__animated animate__fadeInDown animate__delay-2-5s">Why ArtCODE?</h1>
        <p class="col-md-8 fs-5 fw-bold animate__animated animate__fadeInUp animate__delay-2-5s">ArtCODE is an online platform that combines the best features of Pixiv and Pinterest to create a unique and immersive experience for artists and art enthusiasts alike. Whether you're a seasoned professional or a budding beginner, ArtCODE provides a welcoming community where you can showcase your talent and connect with like-minded individuals from all over the world.</p>
      </div>
    </div>
    <div class="row mb-5 animate__animated animate__fadeIn animate__delay-3s">
      <div class="col-md-4 py-2">
        <div class="card h-100 clickable-card rounded-4 border-0 bg-body-tertiary">
          <div class="card-body">
            ...
            <p class="fw-bold">With ArtCODE, you can quickly and easily find the perfect artwork for your project or collection.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4 py-2">
        <div class="card h-100 clickable-card rounded-4 border-0 bg-body-tertiary">
          <div class="card-body">
            ...
            <p class="fw-bold">ArtCODE connects you with a global community of artists and art lovers, allowing you to discover new perspectives and inspiration from around the world.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4 py-2">
        <div class="card h-100 clickable-card rounded-4 border-0 bg-body-tertiary">
          <div class="card-body">
            ...
            <p class="fw-bold">ArtCODE offers a diverse range of high-quality artworks, including traditional paintings, digital art, and more, to suit any taste and style.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="row align-items-md-stretch py-3 animate__animated animate__fadeIn animate__delay-3-5s">
      <div class="col-md-6 mb-down">
        <div class="h-100 p-5 text-white bg-dark rounded-3 clickable-card">
      ...
      <div class="col-md-6">
        <div class="h-100 p-5 bg-light border rounded-3 clickable-card">
