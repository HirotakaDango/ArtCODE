...
<html lang="en" data-bs-theme="dark">
  ...
  <body>
    ...
    <div class="container my-3">
      <h1 class="mb-4 fw-bold">Parodies</h1>
      <?php
        // Fetch JSON data from api_manga_parodies.php
        $json = file_get_contents($web . '/api_manga_parodies.php');
        ...
        if (is_array($data) && !empty($data)) {
          ...
          // Group parodies by their starting character or letter
          $groupedParodies = [];
          foreach ($parodies as $parody => $count) {
            ...
            if (!isset($groupedParodies[$firstCharUpper])) {
              $groupedParodies[$firstCharUpper] = [];
            }
            $groupedParodies[$firstCharUpper][$parody] = $count;
          }
            ...
            <div id="category-<?php echo $group; ?>" class="category-section pt-5">
              ...
              <?php foreach ($parodies as $parody => $count): ?>
                <div class="btn-group my-1 w-100">
                  <a href="index.php?parody=<?php echo urlencode($parody); ?>" class="btn bg-secondary-subtle fw-bold text-start">
