    <nav class="navbar navbar-expand-md bg-body-tertiary">
      <div class="container-fluid">
        <a class="navbar-brand fw-bold" href="/manga/">ArtCODE - Manga</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 fw-medium">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == 'artists.php') echo 'active' ?>" href="/manga/artists.php"><i class="bi bi-person-circle"></i> Artists</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == 'groups.php') echo 'active' ?>" href="/manga/groups.php"><i class="bi bi-person-fill"></i> Groups</a>
            </li>
            <li class="nav-item">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu rounded-4 shadow border-0">
                  ...
                  <?php
                    ...
                    if (isset($loggedInUserId)) {
                      ...
                      ?>
                        <li><a class="dropdown-item fw-medium<?php echo ($isProfileActive ? ' active' : ''); ?>" href="/manga/forum/user.php?id=<?php echo $loggedInUserId; ?>">Profile</a></li>
                        <li><a class="dropdown-item fw-medium<?php echo (basename($_SERVER['PHP_SELF']) == 'settings.php' ? ' active' : ''); ?>" href="/manga/forum/settings.php">Settings</a></li>
                      <?php
                    } else {
                      // If the user is not logged in, show a login button
                      ?>
                        <li><a class="dropdown-item fw-medium" href="/manga/forum/session.php">Login</a></li>
                      <?php
                    }
                  ?>
