      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <img class="rounded-circle img-thumbnail" src="<?php echo !empty($pic) ? $pic : "icon/profile.svg"; ?>" alt="Current Profile Picture" class="img-thumbnail" style="width: 100%; height: 300px; object-fit: cover;">
            <br><br>
