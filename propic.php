        ...
        <div class="offcanvas offcanvas-start w-50" tabindex="-1" id="navbar" aria-labelledby="navbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-bold">
              ...
              <li class="nav-item">
                <a class="nav-link nav-center active" href="propic.php">
    ...
    <div class="container my-3">
      <div class="row justify-content-center">
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center text-secondary fw-bold">Change Profile Picture</h5>
              <img class="rounded-circle img-thumbnail" src="<?php echo !empty($current_pic) ? $current_pic : "icon/profile.svg"; ?>" alt="Current Profile Picture" class="img-thumbnail" style="width: 100%; height: 300px; object-fit: cover;">
              <br><br>

              <form method="post" enctype="multipart/form-data">
                <div class="form-group mb-3">
                  <label for="pic" class="form-label text-secondary fw-bold">Select a new profile picture:</label>
